...
@interface ChangeCellViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,NIMLoginManagerDelegate,NIMConversationManagerDelegate>
/**
 *  会话列表tableView
 */
...
- (void)secretClear:(NIMRecentSession *)recent
             //: atIndexPath:(NSIndexPath *)indexPath;
             manager:(NSIndexPath *)indexPath;
