...
// __M_A_C_R_O__
//: #import "ZZZTimePickerView.h"
#import "DecarboniseView.h"
//: #import "UIViewNimKit.h"
#import "UIViewNimKit.h"
 

//: @interface ZZZTimePickerView()<UIPickerViewDelegate,UIPickerViewDataSource>
@interface DecarboniseView()<UIPickerViewDelegate,UIPickerViewDataSource>
...
//: @implementation ZZZTimePickerView
@implementation DecarboniseView
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_bkgBtn addTarget:self action:@selector(thoracicVertebra:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)thoracicVertebra:(id)sender{
    ...
    if ([self.delegate respondsToSelector:@selector(nimColor:hourState:)]) {
        //: [self.delegate didSelectHour:hour minute:minute];
        [self.delegate nimColor:hour hourState:minute];
    }
    //: if (self.handler) {
    if (self.handler) {
