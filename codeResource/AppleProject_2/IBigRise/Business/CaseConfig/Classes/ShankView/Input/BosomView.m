...
- (void)setSizeTitle:(NSString *)contentText
{
...
//        if (type.integerValue == DataInputBarItemTypeTextAndRecord) {
//            continue;
//        }
...
//    if ([self.types containsObject:@(DataInputBarItemTypeTextAndRecord)]) {
...
//: #pragma mark - Get
#pragma mark - Get
//: - (UIView *)subViewForType:(DataInputBarItemType)type{
- (UIView *)recordLine:(DataInputBarItemType)type{
    //: if (!_dict) {
    if (!_dict) {
        //: _dict = @{
        _dict = @{
                  //: @(DataInputBarItemTypeVoice) : self.voiceButton,
                  @(DataInputBarItemTypeVoice) : self.voiceButton,
//                  @(DataInputBarItemTypeTextAndRecord)  : self.inputTextBkgImage,
                  //: @(DataInputBarItemTypeEmoticon) : self.emoticonBtn,
                  @(DataInputBarItemTypeEmoticon) : self.emoticonBtn,
//                  @(DataInputBarItemTypeMore)     : self.moreMediaBtn,
                  //: @(DataInputBarItemTypeSend) : self.sendButton,
                  @(DataInputBarItemTypeSend) : self.sendButton,
                //: };
                };
    }
