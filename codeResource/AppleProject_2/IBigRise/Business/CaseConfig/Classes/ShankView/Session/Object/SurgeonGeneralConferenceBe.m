...
- (void)nameManager:(NSNotification *)notification {
    ...
    NSDictionary *userInfo = notification.userInfo;
    //: extern NSString *kConst_controlData;
    extern NSString *kConst_controlData;
    //: NSArray *teamIds = userInfo[kConst_controlData];
    NSArray *teamIds = userInfo[kConst_controlData];
...
- (void)supplementSession
{
    ...
    if (self.session.sessionType == NIMSessionTypeTeam || self.session.sessionType == NIMSessionTypeSuperTeam) {
        ...
        extern NSString *const kConst_pathValue;
        //: extern NSString *const kConst_cellTopValue;
        extern NSString *const kConst_cellTopValue;

        //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onTeamInfoHasUpdatedNotification:) name:kConst_pathValue object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(lighted:) name:kConst_pathValue object:nil];
        //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onTeamMembersHasUpdatedNotification:) name:kConst_cellTopValue object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(nameManager:) name:kConst_cellTopValue object:nil];
    }

    //: extern NSString *const kConst_outsideName;
    extern NSString *const kConst_outsideName;
    //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onUserInfoHasUpdatedNotification:) name:kConst_outsideName object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(pubed:) name:kConst_outsideName object:nil];
}
