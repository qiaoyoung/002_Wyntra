...
#import "VagaryItem.h"            //多媒体面板对象
//: #import "ZZZMessageModel.h"         //message Wrapper
#import "CollectionModel.h"         //message Wrapper
//: #import "ZZZKitMessageProvider.h"
#import "EmptySizeWith.h"
//: #import "DataCellConfig.h"           //message cell配置协议
#import "DataCellConfig.h"           //message cell配置协议
//: #import "DataInputProtocol.h"        //输入框回调
#import "DataInputProtocol.h"        //输入框回调
//: #import "ZZZKitDataProvider.h"      //APP内容提供器
#import "RubricStatus.h"      //APP内容提供器
//: #import "DataMessageCellProtocol.h"  //message cell事件回调
#import "DataMessageCellProtocol.h"  //message cell事件回调
//: #import "ZZZSessionConfig.h"        //会话页面配置
#import "PastConfig.h"        //会话页面配置
//: #import "ZZZKitEvent.h"             //点击事件封装类
#import "ItemTap.h"             //点击事件封装类
...
//: #import "DataChatUIManagerProtocol.h"
#import "DataChatUIManagerProtocol.h"
