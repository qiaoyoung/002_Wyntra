...
Byte kStr_thereName[] = {19, 22, 16, 5, 239, 82, 91, 79, 93, 85, 84, 89, 81, 79, 99, 88, 95, 95, 100, 79, 96, 98, 85, 99, 99, 85, 84, 189};


//: message_send_camera
Byte kStr_housingHimTitle[] = {77, 19, 1, 14, 4, 112, 134, 120, 163, 119, 214, 128, 79, 40, 108, 100, 114, 114, 96, 102, 100, 94, 114, 100, 109, 99, 94, 98, 96, 108, 100, 113, 96, 44};


//: bk_media_picture_pressed
Byte kStr_physicContent[] = {29, 24, 63, 12, 116, 201, 226, 83, 212, 180, 212, 5, 35, 44, 32, 46, 38, 37, 42, 34, 32, 49, 42, 36, 53, 54, 51, 38, 32, 49, 51, 38, 52, 52, 38, 37, 94};


//: {9,11,0,15}
Byte kStr_drivingCurData[] = {59, 11, 72, 9, 177, 51, 138, 194, 16, 51, 241, 228, 233, 233, 228, 232, 228, 233, 237, 53, 238};


//: {11,15,9,9}
Byte kStr_decentValue[] = {39, 11, 26, 5, 128, 97, 23, 23, 18, 23, 27, 18, 31, 18, 31, 99, 140};


//: #333333
Byte kStr_gemValue[] = {70, 7, 25, 7, 60, 193, 48, 10, 26, 26, 26, 26, 26, 26, 50};


//: message_send_album
Byte kStr_lobeTeachValue[] = {1, 18, 27, 13, 121, 29, 219, 23, 76, 97, 28, 210, 90, 82, 74, 88, 88, 70, 76, 74, 68, 88, 74, 83, 73, 68, 70, 81, 71, 90, 82, 29};


//: {11,11,9,15}
Byte kStr_sadData[] = {92, 12, 41, 5, 255, 82, 8, 8, 3, 8, 8, 3, 16, 3, 8, 12, 84, 1};


//: onTapMediaItemShoot:
Byte kStr_verbalText[] = {59, 20, 4, 7, 47, 195, 40, 107, 106, 80, 93, 108, 73, 97, 96, 101, 93, 69, 112, 97, 105, 79, 100, 107, 107, 112, 54, 101};


//: bk_media_position_normal
Byte kStr_torySortName[] = {20, 24, 16, 8, 77, 39, 100, 77, 82, 91, 79, 93, 85, 84, 89, 81, 79, 96, 95, 99, 89, 100, 89, 95, 94, 79, 94, 95, 98, 93, 81, 92, 172};


//: {9,15,9,9}
Byte kStr_stretchBureauGrossName[] = {98, 10, 9, 13, 102, 124, 91, 157, 65, 182, 61, 212, 76, 114, 48, 35, 40, 44, 35, 48, 35, 48, 116, 233};


//: Audios
Byte kStr_studentData[] = {2, 6, 39, 4, 26, 78, 61, 66, 72, 76, 16};


//: icon_session_time_bg
Byte kStr_excludeValue[] = {41, 20, 97, 13, 127, 30, 236, 239, 231, 224, 16, 212, 70, 8, 2, 14, 13, 254, 18, 4, 18, 18, 8, 14, 13, 254, 19, 8, 12, 4, 254, 1, 6, 14};


//: onTapMediaItemLocation:
Byte kStr_legislativeContent[] = {4, 23, 69, 14, 59, 20, 175, 42, 192, 145, 91, 248, 166, 136, 42, 41, 15, 28, 43, 8, 32, 31, 36, 28, 4, 47, 32, 40, 7, 42, 30, 28, 47, 36, 42, 41, 245, 163};


//: {9,11,9,15}
Byte kStr_conferenceData[] = {42, 11, 92, 6, 252, 3, 31, 221, 208, 213, 213, 208, 221, 208, 213, 217, 33, 156};


//: {5,15,5,9}
Byte kStr_egretText[] = {77, 10, 81, 9, 184, 201, 241, 121, 115, 42, 228, 219, 224, 228, 219, 228, 219, 232, 44, 27};


//: {3,3,3,8}
Byte kStr_weekendShouldValue[] = {56, 9, 27, 11, 2, 84, 31, 174, 2, 57, 189, 96, 24, 17, 24, 17, 24, 17, 29, 98, 63};


//: bk_media_shoot_normal
Byte kStr_billDriverData[] = {49, 21, 74, 5, 90, 24, 33, 21, 35, 27, 26, 31, 23, 21, 41, 30, 37, 37, 42, 21, 36, 37, 40, 35, 23, 34, 24};


//: onTapMenuItemCopy:
Byte kStr_peValue[] = {71, 18, 53, 12, 198, 128, 58, 219, 110, 100, 35, 11, 58, 57, 31, 44, 59, 24, 48, 57, 64, 20, 63, 48, 56, 14, 58, 59, 68, 5, 92};


//: onTapMediaItemPicture:
Byte kStr_markViewName[] = {27, 22, 59, 6, 119, 251, 52, 51, 25, 38, 53, 18, 42, 41, 46, 38, 14, 57, 42, 50, 21, 46, 40, 57, 58, 55, 42, 255, 183};


//: {8,13,9,12}
Byte kStr_humName[] = {50, 11, 21, 10, 110, 119, 250, 214, 52, 16, 102, 35, 23, 28, 30, 23, 36, 23, 28, 29, 104, 103};


//: bk_media_picture_normal
Byte kStr_readilyEconomicalData[] = {9, 23, 97, 11, 32, 102, 181, 250, 64, 28, 204, 1, 10, 254, 12, 4, 3, 8, 0, 254, 15, 8, 2, 19, 20, 17, 4, 254, 13, 14, 17, 12, 0, 11, 14};


//: {9,15,0,9}
Byte kStr_diplomaticContentRowValue[] = {33, 10, 10, 14, 47, 5, 242, 62, 70, 173, 24, 242, 90, 13, 113, 47, 34, 39, 43, 34, 38, 34, 47, 115, 87};


//: onTapMenuItemDelete:
Byte kStr_improveContent[] = {48, 20, 99, 5, 243, 12, 11, 241, 254, 13, 234, 2, 11, 18, 230, 17, 2, 10, 225, 2, 9, 2, 17, 2, 215, 240};


//: {3,8,3,3}
Byte kStr_chronicHistoricallyData[] = {83, 9, 58, 7, 247, 50, 207, 65, 249, 242, 254, 242, 249, 242, 249, 67, 127};


//: {5,11,5,15}
Byte kStr_truckConfusionTitle[] = {45, 11, 7, 5, 243, 116, 46, 37, 42, 42, 37, 46, 37, 42, 46, 118, 116};


//: {8,12,9,14}
Byte kStr_galaxyContent[] = {6, 11, 46, 11, 157, 100, 57, 24, 165, 184, 29, 77, 10, 254, 3, 4, 254, 11, 254, 3, 6, 79, 190};


//: {8,20,8,20}
Byte kStr_playoffViseValue[] = {89, 11, 8, 12, 130, 44, 105, 117, 110, 208, 23, 52, 115, 48, 36, 42, 40, 36, 48, 36, 42, 40, 117, 203};
...
- (instancetype)initTarget:(BOOL)isRight;
...
- (NSArray *)accumulationFrame
{
    //: return @[[ZZZMediaItem item:@"onTapMediaItemPicture:"
    return @[[VagaryItem confines:StringFromFellData(kStr_markViewName)
           //: normalImage:[UIImage imageNamed:@"bk_media_picture_normal"]
           session:[UIImage imageNamed:StringFromFellData(kStr_readilyEconomicalData)]
         //: selectedImage:[UIImage imageNamed:@"bk_media_picture_normal"]
         searched:[UIImage imageNamed:StringFromFellData(kStr_readilyEconomicalData)]
                 //: title:[NTESLanguageManager getTextWithKey:@"message_send_album"]],//@"相册".nim_localized
                 numberelligentsia:[LabelCell tinkleKey:StringFromFellData(kStr_lobeTeachValue)]],//@"相册".nim_localized

    //: [ZZZMediaItem item:@"onTapMediaItemShoot:"
    [VagaryItem confines:StringFromFellData(kStr_verbalText)
           //: normalImage:[UIImage imageNamed:@"bk_media_shoot_normal"]
           session:[UIImage imageNamed:StringFromFellData(kStr_billDriverData)]
         //: selectedImage:[UIImage imageNamed:@"bk_media_shoot_normal"]
         searched:[UIImage imageNamed:StringFromFellData(kStr_billDriverData)]
                 //: title:[NTESLanguageManager getTextWithKey:@"message_send_camera"]],//@"拍摄".nim_localized
                 numberelligentsia:[LabelCell tinkleKey:StringFromFellData(kStr_housingHimTitle)]],//@"拍摄".nim_localized

    //: [ZZZMediaItem item:@"onTapMediaItemLocation:"
    [VagaryItem confines:StringFromFellData(kStr_legislativeContent)
           //: normalImage:[UIImage imageNamed:@"bk_media_position_normal"]
           session:[UIImage imageNamed:StringFromFellData(kStr_torySortName)]
         //: selectedImage:[UIImage imageNamed:@"bk_media_position_normal"]
         searched:[UIImage imageNamed:StringFromFellData(kStr_torySortName)]
                 //: title:[NTESLanguageManager getTextWithKey:@"Audios"]],//@"位置".nim_localized
                 numberelligentsia:[LabelCell tinkleKey:StringFromFellData(kStr_studentData)]],//@"位置".nim_localized
...
- (NSArray *)line:(NIMMessage *)message
{
    ...
    if (message.messageType == NIMMessageTypeText)
    {
        ...
        [menuItems addObject:[VagaryItem confines:StringFromFellData(kStr_peValue)
                                    //: normalImage:[UIImage imageNamed:@"bk_media_picture_normal"]
                                    session:[UIImage imageNamed:StringFromFellData(kStr_readilyEconomicalData)]
                                  //: selectedImage:[UIImage imageNamed:@"bk_media_picture_pressed"]
                                  searched:[UIImage imageNamed:StringFromFellData(kStr_physicContent)]
    ...
    VagaryItem *delItem = [VagaryItem confines:StringFromFellData(kStr_improveContent)
                                //: normalImage:[UIImage imageNamed:@"bk_media_shoot_normal"]
                                session:[UIImage imageNamed:StringFromFellData(kStr_billDriverData)]
                              //: selectedImage:[UIImage imageNamed:@"bk_media_shoot_pressed"]
                              searched:[UIImage imageNamed:StringFromFellData(kStr_thereName)]
                                      //: title:@"删除".nim_localized];
                                      numberelligentsia:@"删除".start];
...
- (void)shootRecord
{
    ...
    _nickColor = [UIColor box:StringFromFellData(kStr_gemValue)];
    ...
    _leftBubbleSettings = [[StatuteNameTitle alloc] initTarget:NO];
    //: _rightBubbleSettings = [[ZZZKitSettings alloc] init:YES];
    _rightBubbleSettings = [[StatuteNameTitle alloc] initTarget:YES];
}

//: - (ZZZKitSetting *)setting:(NIMMessage *)message
- (CaseSetting *)style:(NIMMessage *)message
{
    //: ZZZKitSettings *settings = message.isOutgoingMsg? self.rightBubbleSettings : self.leftBubbleSettings;
    StatuteNameTitle *settings = message.isOutgoingMsg? self.rightBubbleSettings : self.leftBubbleSettings;
...
- (CaseSetting *)shouldPath:(NIMMessage *)message
{
    //: ZZZKitSettings *settings = message.isOutgoingMsg? self.rightBubbleSettings : self.leftBubbleSettings;
    StatuteNameTitle *settings = message.isOutgoingMsg? self.rightBubbleSettings : self.leftBubbleSettings;
...
@implementation StatuteNameTitle
...
- (void)messageVideo
{
    ...
    _repliedSetting = [[CaseSetting alloc] init];
    //: _repliedSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{9,11,0,15}") : UIEdgeInsetsFromString(@"{9,15,0,9}");
    _repliedSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromFellData(kStr_drivingCurData)) : UIEdgeInsetsFromString(StringFromFellData(kStr_diplomaticContentRowValue));
...
- (void)cellCan
{
    ...
    _textSetting = [[CaseSetting alloc] initContainer:_isRight];
    //: _textSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{5,11,5,15}") : UIEdgeInsetsFromString(@"{5,15,5,9}");
    _textSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromFellData(kStr_truckConfusionTitle)) : UIEdgeInsetsFromString(StringFromFellData(kStr_egretText));
...
- (void)tapOff
{
    ...
    _audioSetting = [[CaseSetting alloc] initContainer:_isRight];
    //: _audioSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{8,12,9,14}") : UIEdgeInsetsFromString(@"{8,13,9,12}");
    _audioSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromFellData(kStr_galaxyContent)) : UIEdgeInsetsFromString(StringFromFellData(kStr_humName));
...
- (void)range
{
    ...
    _videoSetting = [[CaseSetting alloc] initContainer:_isRight];
    //: _videoSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{3,3,3,8}") : UIEdgeInsetsFromString(@"{3,8,3,3}");
    _videoSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromFellData(kStr_weekendShouldValue)) : UIEdgeInsetsFromString(StringFromFellData(kStr_chronicHistoricallyData));
...
- (void)modelSettings
{
    ...
    _fileSetting = [[CaseSetting alloc] initContainer:_isRight];
    //: _fileSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{3,3,3,8}") : UIEdgeInsetsFromString(@"{3,8,3,3}");
    _fileSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromFellData(kStr_weekendShouldValue)) : UIEdgeInsetsFromString(StringFromFellData(kStr_chronicHistoricallyData));
...
- (void)halogen
{
    ...
    _imageSetting = [[CaseSetting alloc] initContainer:_isRight];
    //: _imageSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{3,3,3,8}") : UIEdgeInsetsFromString(@"{3,8,3,3}");
    _imageSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromFellData(kStr_weekendShouldValue)) : UIEdgeInsetsFromString(StringFromFellData(kStr_chronicHistoricallyData));
...
- (void)by
{
    ...
    _locationSetting = [[CaseSetting alloc] initContainer:_isRight];
    //: _locationSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{3,3,3,8}") : UIEdgeInsetsFromString(@"{3,8,3,3}");
    _locationSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromFellData(kStr_weekendShouldValue)) : UIEdgeInsetsFromString(StringFromFellData(kStr_chronicHistoricallyData));
...
- (void)disable
{
    ...
    _tipSetting = [[CaseSetting alloc] initContainer:_isRight];
    ...
    UIImage *backgroundImage = [[UIImage imageNamed:StringFromFellData(kStr_excludeValue)] resizableImageWithCapInsets:UIEdgeInsetsFromString(StringFromFellData(kStr_playoffViseValue)) resizingMode:UIImageResizingModeStretch];;
...
- (void)blue
{
    ...
    _rtcCallRecordSetting = [[CaseSetting alloc] initContainer:_isRight];
    //: _rtcCallRecordSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{9,11,9,15}") : UIEdgeInsetsFromString(@"{9,15,9,9}");
    _rtcCallRecordSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromFellData(kStr_conferenceData)) : UIEdgeInsetsFromString(StringFromFellData(kStr_stretchBureauGrossName));
...
- (void)target
{
    ...
    _unsupportSetting = [[CaseSetting alloc] initContainer:_isRight];
    //: _unsupportSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{11,11,9,15}") : UIEdgeInsetsFromString(@"{11,15,9,9}");
    _unsupportSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromFellData(kStr_sadData)) : UIEdgeInsetsFromString(StringFromFellData(kStr_decentValue));
...
- (void)sendJuniorVarsity
{
    //: _teamNotificationSetting = [[ZZZKitSetting alloc] init:_isRight];
    _teamNotificationSetting = [[CaseSetting alloc] initContainer:_isRight];
...
- (void)image
{
    ...
    _superTeamNotificationSetting = [[CaseSetting alloc] initContainer:_isRight];
...
- (void)allowUser
{
    ...
    _chatroomNotificationSetting = [[CaseSetting alloc] initContainer:_isRight];
...
- (void)request
{
    ...
    _netcallNotificationSetting = [[CaseSetting alloc] initContainer:_isRight];
    //: _netcallNotificationSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{11,11,9,15}") : UIEdgeInsetsFromString(@"{11,15,9,9}");
    _netcallNotificationSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromFellData(kStr_sadData)) : UIEdgeInsetsFromString(StringFromFellData(kStr_decentValue));
...
Byte * FellDataToCache(Byte *data) {
    int mediaNag = data[0];
    int wheatReach = data[1];
    Byte be = data[2];
    int truck = data[3];
    if (!mediaNag) return data + truck;
    for (int i = truck; i < truck + wheatReach; i++) {
        int value = data[i] + be;
        if (value > 255) {
            value -= 256;
        }
