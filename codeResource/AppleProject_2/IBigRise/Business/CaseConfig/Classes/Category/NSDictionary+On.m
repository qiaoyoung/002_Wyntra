...
@implementation NSDictionary (On)

//: - (NSString *)nimkit_jsonString: (NSString *)key
- (NSString *)imaginationImage: (NSString *)key
{
...
- (NSDictionary *)titleAccept: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (NSArray *)status: (NSString *)key
{
    //: NSArray *array = [self nimkit_jsonArray:key];
    NSArray *array = [self range:key];
    //: BOOL invalid = NO;
    BOOL invalid = NO;
...
- (NSInteger)soundAdd: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (long long)gestureCrop: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (unsigned long long)languageUponSumerminable:(NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (double)telegramCover: (NSString *)key{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
    if ([object isKindOfClass:[NSString class]] ||
