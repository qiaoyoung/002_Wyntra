...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kLittleCabbage];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kLittleCabbage];
    ...
    NSString *path = [[AppleProjectKit sharedKit].emoticonBundle pathForResource:kLittleCabbage ofType:@".zip"];
    if (!path) {
