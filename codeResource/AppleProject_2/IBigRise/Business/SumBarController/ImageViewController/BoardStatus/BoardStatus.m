...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    switch (self.currentOpearation) {
        ...
        case UINavigationControllerOperationPop:
            ...
            [self bottom:transitionContext];
            //: break;
            break;
        //: case UINavigationControllerOperationPush:
        case UINavigationControllerOperationPush:
            //: [self pushAnimation:transitionContext];
            [self videoItemAnimation:transitionContext];
            //: break;
            break;
        //: default:
        default:
...
- (void)videoItemAnimation:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if ((toViewController.edgesForExtendedLayout & UIRectEdgeBottom) == 0) {
        ...
        // 检查 tabbarController 是否为 SumBarController
        //: if ([tabbarController isKindOfClass:[NTESMainTabController class]]) {
        if ([tabbarController isKindOfClass:[SumBarController class]]) {
            //: NTESMainTabController *mainTabController = (NTESMainTabController *)tabbarController;
            SumBarController *mainTabController = (SumBarController *)tabbarController;
...
- (void)bottom:(id<UIViewControllerContextTransitioning>)transitionContext
{
    //: UIViewController *toViewController = [transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    UIViewController *toViewController = [transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    //: UIViewController *fromViewController = [transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    ...
    CGFloat snapshootHeight = [UIDevice encounter] + fromViewController.navigationController.navigationBar.height;
...
- (void)success
{
    ...
    if ([self.delegate respondsToSelector:@selector(letters:)]) {
        //: [self.delegate animationDidEnd:self];
        [self.delegate letters:self];
    }
}
