...
@protocol CandlestickDelegate <NSObject>
//: - (void)onNTESTimerFired:(NTESTimerHolder *)holder;
- (void)blueDistance:(ContainerHolder *)holder;
//: @end
@end

//: @interface NTESTimerHolder : NSObject
@interface ContainerHolder : NSObject
//: @property (nonatomic,weak) id<NTESTimerHolderDelegate> timerDelegate;
@property (nonatomic,weak) id<CandlestickDelegate> timerDelegate;
