...
@interface ValueTitlePerson : NSObject
...
@property (nonatomic, copy) NSArray <SelectMarginContainer *> *phones;
...
@interface SelectMarginContainer : NSObject
...
@interface EnableFile : NSObject

//: @property (nonatomic, copy) NSString *key;
@property (nonatomic, copy) NSString *key;

//: @property (nonatomic, copy) NSArray <ZZZContactPerson *> *persons;
@property (nonatomic, copy) NSArray <ValueTitlePerson *> *persons;
