...
NSString *StringFromCircleData(Byte *data);


//: 同意成功
Byte kStr_tingCurrentScanData[] = {63, 12, 9, 228, 159, 154, 113, 78, 73, 159, 138, 229, 144, 136, 230, 143, 132, 230, 140, 144, 229, 51};


//: group_info_activity_team_not_exist
Byte kStr_activityTapRedData[] = {16, 34, 3, 116, 115, 105, 120, 101, 95, 116, 111, 110, 95, 109, 97, 101, 116, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 112, 117, 111, 114, 103, 50};


//: successful_authentication
Byte kStr_sendTingName[] = {48, 25, 6, 181, 199, 248, 110, 111, 105, 116, 97, 99, 105, 116, 110, 101, 104, 116, 117, 97, 95, 108, 117, 102, 115, 115, 101, 99, 99, 117, 115, 247};


//: fail_authentication
Byte kStr_currentUserValue[] = {18, 19, 12, 52, 21, 114, 163, 43, 122, 65, 37, 165, 110, 111, 105, 116, 97, 99, 105, 116, 110, 101, 104, 116, 117, 97, 95, 108, 105, 97, 102, 142};


//: 拒绝失败,请重试
Byte kStr_scanEventTitle[] = {34, 22, 5, 112, 71, 149, 175, 232, 141, 135, 233, 183, 175, 232, 44, 165, 180, 232, 177, 164, 229, 157, 187, 231, 146, 139, 230, 85};


//: message_helper_already_no
Byte kStr_barUserValue[] = {98, 25, 8, 92, 6, 197, 213, 240, 111, 110, 95, 121, 100, 97, 101, 114, 108, 97, 95, 114, 101, 112, 108, 101, 104, 95, 101, 103, 97, 115, 115, 101, 109, 123};


//: friend_verify_avtivity_net_error
Byte kStr_withViewName[] = {52, 32, 3, 114, 111, 114, 114, 101, 95, 116, 101, 110, 95, 121, 116, 105, 118, 105, 116, 118, 97, 95, 121, 102, 105, 114, 101, 118, 95, 100, 110, 101, 105, 114, 102, 189};


//: 接受成功
Byte kStr_withSendValue[] = {99, 12, 11, 105, 192, 235, 59, 34, 146, 49, 53, 159, 138, 229, 144, 136, 230, 151, 143, 229, 165, 142, 230, 244};
...
@interface DitheredColorView ()<NIMSystemNotificationManagerDelegate,SystemWith,UITableViewDelegate,UITableViewDataSource>
...
@implementation DitheredColorView
        ...
        case NIMSystemNotificationTypeTeamApply:{
            ...
            [[NIMSDK sharedSDK].teamManager passApplyToTeam:notification.targetID userId:notification.sourceID completion:^(NSError *error, NIMTeamApplyStatus applyStatus) {
                ...
                if (!error) {
                    ...
                    [wself makeToast:StringFromCircleData(kStr_tingCurrentScanData).colorLocalized
                                                      //: duration:2
                                                      duration:2
                ...
                //: }else {
                    ...
                    if(error.code == NIMRemoteErrorCodeTimeoutError) {
                        ...
                        [wself makeToast:[LabelCell tinkleKey:StringFromCircleData(kStr_withViewName)]
                                                          //: duration:2
                                                          duration:2
                                                          //: position:CSToastPositionCenter];
                                                          position:CSToastPositionCenter];
        ...
        case NIMSystemNotificationTypeTeamInvite:{
            ...
            [[NIMSDK sharedSDK].teamManager acceptInviteWithTeam:notification.targetID invitorId:notification.sourceID completion:^(NSError *error) {
                ...
                if (!error) {
                    ...
                    [wself makeToast:StringFromCircleData(kStr_withSendValue).colorLocalized
                                                      //: duration:2
                                                      duration:2
                                                      //: position:CSToastPositionCenter];
                                                      position:CSToastPositionCenter];
                ...
                //: }else {
                    ...
                    //: else if (error.code == NIMRemoteErrorCodeTeamNotExists) {
                        ...
                        [wself makeToast:[LabelCell tinkleKey:StringFromCircleData(kStr_activityTapRedData)]
                                                          //: duration:2
                                                          duration:2
                                                          //: position:CSToastPositionCenter];
                                                          position:CSToastPositionCenter];
            ...
            [[[NIMSDK sharedSDK] userManager] requestFriend:request
                                                 ...
                                                 completion:^(NSError *error) {
                                                     ...
                                                     if (!error) {
                                                         ...
                                                         [wself makeToast:[LabelCell tinkleKey:StringFromCircleData(kStr_sendTingName)]//@"验证成功".ntes_localized
                                                                                           //: duration:2
                                                                                           duration:2
                                                                                           //: position:CSToastPositionCenter];
                                                                                           position:CSToastPositionCenter];
...
//                                                         [[NIMSDK sharedSDK].chatManager sendMessage:message toSession:session error:&error];
                                                     ...
                                                     else
                                                     {
                                                         ...
                                                         [wself makeToast:[LabelCell tinkleKey:StringFromCircleData(kStr_currentUserValue)]//@"验证失败,请重试".ntes_localized
                                                                                           //: duration:2
                                                                                           duration:2
                                                                                           //: position:CSToastPositionCenter];
                                                                                           position:CSToastPositionCenter];
        ...
        case NIMSystemNotificationTypeTeamApply:{
            ...
            [[NIMSDK sharedSDK].teamManager rejectApplyToTeam:notification.targetID userId:notification.sourceID rejectReason:@"" completion:^(NSError *error) {
                ...
                if (!error) {
                    ...
                    [wself makeToast:[LabelCell tinkleKey:StringFromCircleData(kStr_barUserValue)]
                                                      //: duration:2
                                                      duration:2
                                                      //: position:CSToastPositionCenter];
                                                      position:CSToastPositionCenter];
            ...
            [[[NIMSDK sharedSDK] userManager] requestFriend:request
                                                 ...
                                                 completion:^(NSError *error) {
                                                     ...
                                                     else
                                                     {
                                                         ...
                                                         [wself makeToast:StringFromCircleData(kStr_scanEventTitle).colorLocalized
                                                                                           //: duration:2
                                                                                           duration:2
                                                                                           //: position:CSToastPositionCenter];
                                                                                           position:CSToastPositionCenter];
...
Byte * CircleDataToCache(Byte *data) {
    int tapTime = data[0];
    int sizeSelected = data[1];
    int sessionAtTitle = data[2];
    if (!tapTime) return data + sessionAtTitle;
    for (int i = 0; i < sizeSelected / 2; i++) {
        int begin = sessionAtTitle + i;
        int end = sessionAtTitle + sizeSelected - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[sessionAtTitle + sizeSelected] = 0;
    return data + sessionAtTitle;
}

NSString *StringFromCircleData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)CircleDataToCache(data)];
}  
