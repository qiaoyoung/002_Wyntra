...
NSString *StringFromScaleRecordingData(Byte *data);


//: top_notice
Byte kStr_shouldWithValue[] = {8, 10, 78, 10, 32, 57, 60, 180, 43, 123, 194, 189, 190, 173, 188, 189, 194, 183, 177, 179, 32};


//: name
Byte kStr_shootCommentWithData[] = {4, 4, 90, 11, 71, 3, 65, 160, 41, 182, 62, 200, 187, 199, 191, 167};


//: retracted_message
Byte kStr_progressMarkSuccessName[] = {9, 17, 81, 14, 15, 227, 211, 194, 150, 18, 88, 251, 98, 11, 195, 182, 197, 195, 178, 180, 197, 182, 181, 176, 190, 182, 196, 196, 178, 184, 182, 163};


//: ic_distrub
Byte kStr_enableContent[] = {1, 10, 98, 10, 203, 104, 14, 99, 251, 230, 203, 197, 193, 198, 203, 213, 214, 212, 215, 196, 88};


//: 我的电脑
Byte kStr_buttonUseActivityValue[] = {48, 12, 81, 5, 183, 55, 217, 226, 56, 235, 213, 56, 229, 6, 57, 213, 226, 185};


//: jpg
Byte kStr_objectMarkText[] = {2, 3, 30, 11, 78, 207, 246, 134, 189, 190, 246, 136, 142, 133, 132};


//: invite_you_group
Byte kStr_viewTextTitle[] = {63, 16, 43, 5, 219, 148, 153, 161, 148, 159, 144, 138, 164, 154, 160, 138, 146, 157, 154, 160, 155, 111};


//: no_conversation
Byte kStr_timeViewName[] = {74, 15, 66, 13, 132, 186, 56, 150, 109, 60, 173, 62, 65, 176, 177, 161, 165, 177, 176, 184, 167, 180, 181, 163, 182, 171, 177, 176, 187};


//: activity_user_profile_chat
Byte kStr_textButtonData[] = {28, 26, 33, 11, 8, 239, 213, 95, 156, 45, 113, 130, 132, 149, 138, 151, 138, 149, 154, 128, 150, 148, 134, 147, 128, 145, 147, 144, 135, 138, 141, 134, 128, 132, 137, 130, 149, 159};


//: /team/create
Byte kStr_successItemValue[] = {16, 12, 55, 13, 139, 122, 105, 6, 143, 6, 72, 198, 7, 102, 171, 156, 152, 164, 102, 154, 169, 156, 152, 171, 156, 134};


//: /user/checkcreateteam
Byte kStr_textTitleData[] = {76, 21, 87, 12, 90, 246, 223, 201, 82, 195, 88, 121, 134, 204, 202, 188, 201, 134, 186, 191, 188, 186, 194, 186, 201, 188, 184, 203, 188, 203, 188, 184, 196, 187};


//: ic_nodistrub
Byte kStr_sizeMediaValue[] = {66, 12, 48, 9, 200, 162, 164, 235, 102, 153, 147, 143, 158, 159, 148, 153, 163, 164, 162, 165, 146, 167};


//: (同步数据)
Byte kStr_policyLabelText[] = {18, 14, 97, 5, 4, 137, 70, 241, 237, 71, 14, 6, 71, 246, 17, 71, 238, 15, 138, 143};


//: top_add_group
Byte kStr_activityTitle[] = {17, 13, 73, 13, 71, 10, 36, 247, 10, 56, 17, 190, 22, 189, 184, 185, 168, 170, 173, 173, 168, 176, 187, 184, 190, 185, 253};


//: icon_session_list_empty
Byte kStr_enableText[] = {86, 23, 91, 7, 127, 237, 87, 196, 190, 202, 201, 186, 206, 192, 206, 206, 196, 202, 201, 186, 199, 196, 206, 207, 186, 192, 200, 203, 207, 212, 115};


//: owner
Byte kStr_byTextCircleTitle[] = {52, 5, 57, 11, 30, 14, 229, 41, 54, 153, 250, 168, 176, 167, 158, 171, 127};


//: tid
Byte kStr_circleTitleValue[] = {64, 3, 63, 13, 50, 70, 180, 163, 15, 68, 64, 120, 89, 179, 168, 163, 156};


//: 666666
Byte kStr_circleHouseData[] = {80, 6, 81, 4, 135, 135, 135, 135, 135, 135, 39};


//: #999999
Byte kStr_circleValue[] = {76, 7, 96, 14, 40, 157, 203, 207, 21, 101, 191, 76, 95, 126, 131, 153, 153, 153, 153, 153, 153, 61};


//: please_contact_your_administrator
Byte kStr_tapTitle[] = {49, 33, 87, 11, 88, 91, 134, 66, 94, 246, 86, 199, 195, 188, 184, 202, 188, 182, 186, 198, 197, 203, 184, 186, 203, 182, 208, 198, 204, 201, 182, 184, 187, 196, 192, 197, 192, 202, 203, 201, 184, 203, 198, 201, 195};


//: warm_prompt
Byte kStr_recordingViewName[] = {37, 11, 60, 10, 255, 157, 9, 73, 61, 43, 179, 157, 174, 169, 155, 172, 174, 171, 169, 172, 176, 80};


//: type
Byte kStr_timeOperationData[] = {11, 4, 69, 9, 130, 167, 41, 214, 106, 185, 190, 181, 170, 243};


//: team_create_helper_create_failed
Byte kStr_contentBarData[] = {23, 32, 68, 4, 184, 169, 165, 177, 163, 167, 182, 169, 165, 184, 169, 163, 172, 169, 176, 180, 169, 182, 163, 167, 182, 169, 165, 184, 169, 163, 170, 165, 173, 176, 169, 168, 46};


//: activity_create_group_name_create_group
Byte kStr_progressKeyName[] = {31, 39, 56, 9, 50, 252, 1, 70, 39, 153, 155, 172, 161, 174, 161, 172, 177, 151, 155, 170, 157, 153, 172, 157, 151, 159, 170, 167, 173, 168, 151, 166, 153, 165, 157, 151, 155, 170, 157, 153, 172, 157, 151, 159, 170, 167, 173, 168, 251};


//: ic_delete
Byte kStr_lengthSendText[] = {1, 9, 38, 4, 143, 137, 133, 138, 139, 146, 139, 154, 139, 85};


//: tname
Byte kStr_barTextEnableValue[] = {84, 5, 45, 5, 130, 161, 155, 142, 154, 146, 233};


//: ic_topno
Byte kStr_accountText[] = {68, 8, 7, 13, 160, 20, 92, 2, 105, 233, 133, 156, 182, 112, 106, 102, 123, 118, 119, 117, 118, 46};


//: fragment_contact_new_scan
Byte kStr_tingByText[] = {80, 25, 54, 7, 195, 148, 50, 156, 168, 151, 157, 163, 155, 164, 170, 149, 153, 165, 164, 170, 151, 153, 170, 149, 164, 155, 173, 149, 169, 153, 151, 164, 64};


//: top_add_friend
Byte kStr_recordingViewValue[] = {61, 14, 27, 11, 137, 228, 113, 101, 116, 103, 112, 143, 138, 139, 122, 124, 127, 127, 122, 129, 141, 132, 128, 137, 127, 189};


//: (连接中)
Byte kStr_withContent[] = {70, 11, 50, 8, 122, 213, 179, 210, 90, 26, 241, 208, 24, 192, 215, 22, 234, 223, 91, 169};


//: [有人@你]
Byte kStr_itemViewData[] = {12, 12, 25, 13, 82, 109, 9, 62, 198, 170, 47, 129, 73, 116, 255, 181, 162, 253, 211, 211, 89, 253, 214, 185, 118, 18};


//: #875FFA
Byte kStr_coverTitleSuccessValue[] = {39, 7, 27, 9, 163, 150, 121, 20, 144, 62, 83, 82, 80, 97, 97, 92, 186};


//: tag_activity_set
Byte kStr_keyTimeValue[] = {14, 16, 48, 13, 7, 187, 239, 218, 218, 199, 251, 233, 91, 164, 145, 151, 143, 145, 147, 164, 153, 166, 153, 164, 169, 143, 163, 149, 164, 153};


//: contact_tag_fragment_cancel
Byte kStr_houseContent[] = {63, 27, 68, 7, 169, 41, 97, 167, 179, 178, 184, 165, 167, 184, 163, 184, 165, 171, 163, 170, 182, 165, 171, 177, 169, 178, 184, 163, 167, 165, 178, 167, 169, 176, 244};


//: user_info_avtivity_upload_avatar_failed
Byte kStr_messageObjectData[] = {73, 39, 11, 4, 128, 126, 112, 125, 106, 116, 121, 113, 122, 106, 108, 129, 127, 116, 129, 116, 127, 132, 106, 128, 123, 119, 122, 108, 111, 106, 108, 129, 108, 127, 108, 125, 106, 113, 108, 116, 119, 112, 111, 121};


//: ic_create_chat
Byte kStr_coverNameText[] = {56, 14, 72, 14, 189, 177, 227, 222, 69, 158, 177, 191, 247, 173, 177, 171, 167, 171, 186, 173, 169, 188, 173, 167, 171, 176, 169, 188, 89};


//: (未连接)
Byte kStr_labelLengthValue[] = {74, 11, 66, 8, 78, 163, 108, 229, 106, 40, 222, 236, 42, 1, 224, 40, 208, 231, 107, 10};


//: ic_top
Byte kStr_sizeContent[] = {39, 6, 68, 5, 176, 173, 167, 163, 184, 179, 180, 243};


//: ic_scan
Byte kStr_markTingValue[] = {2, 7, 18, 14, 211, 2, 208, 76, 8, 181, 188, 211, 104, 193, 123, 117, 113, 133, 117, 115, 128, 201};


//: notification
Byte kStr_objectText[] = {51, 12, 75, 8, 26, 216, 103, 197, 185, 186, 191, 180, 177, 180, 174, 172, 191, 180, 186, 185, 131};


//: ic_add_fiend
Byte kStr_keyRedLabelName[] = {59, 12, 33, 10, 88, 2, 151, 89, 3, 92, 138, 132, 128, 130, 133, 133, 128, 135, 138, 134, 143, 133, 47};


//: setting_privacy_camera
Byte kStr_messageItemValue[] = {40, 22, 13, 9, 44, 253, 7, 45, 224, 128, 114, 129, 129, 118, 123, 116, 108, 125, 127, 118, 131, 110, 112, 134, 108, 112, 110, 122, 114, 127, 110, 57};


//: code
Byte kStr_useSendValue[] = {37, 4, 79, 9, 233, 116, 23, 54, 102, 178, 190, 179, 180, 5};


//: globalsign
Byte kStr_itemCircleName[] = {56, 10, 85, 4, 188, 193, 196, 183, 182, 193, 200, 190, 188, 195, 156};


//: add_friend_activity_add_friend
Byte kStr_topData[] = {61, 30, 14, 5, 234, 111, 114, 114, 109, 116, 128, 119, 115, 124, 114, 109, 111, 113, 130, 119, 132, 119, 130, 135, 109, 111, 114, 114, 109, 116, 128, 119, 115, 124, 114, 235};
...
@interface HideViewController ()<NIMLoginManagerDelegate,ViewTitle,NIMEventSubscribeManagerDelegate,UIViewControllerPreviewingDelegate,NIMChatExtendManagerDelegate, NIMConversationManagerDelegate,NIMSystemNotificationManagerDelegate>
...
@property (nonatomic, strong) DitheredColorView *noticeView;
...
@property (nonatomic, strong) PolicySaveView *policyView;
...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil{
    ...
    if (self) {
        ...
        self.autoRemoveRemoteSession = [[BackgroundTingIncidentGreen pickApart] pressed];
    }
    //: return self;
    return self;
}
...
- (void)viewDidLoad{
    ...
    self.header = [[TextView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, 0)];
    ...
    self.emptyImageView.image = [UIImage imageNamed:StringFromScaleRecordingData(kStr_enableText)];
    ...
    self.emptyTipLabel.text = [LabelCell tinkleKey:StringFromScaleRecordingData(kStr_timeViewName)];//@"还没有会话，在通讯录中找个人聊聊吧".ntes_localized;
    ...
    self.emptyTipLabel.textColor = [UIColor box:StringFromScaleRecordingData(kStr_circleValue)];
    ...
    self.tableView.frame = CGRectMake(0, [UIDevice encounter]+140, [[UIScreen mainScreen] bounds].size.width, ([[UIScreen mainScreen] bounds].size.height - (44.0f + [UIDevice encounter]) - (({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom))-140);
    ...
    if(![[AlongDefaults off].yspop isEqualToString:@"1"]){
    ...
    [ViewManager with:^(NSDictionary * _Nonnull configDict) {
        //: if (configDict.allKeys.count > 0) {
        if (configDict.allKeys.count > 0) {
            //: NSString *globalsign = [configDict newStringValueForKey:@"globalsign"];
            NSString *globalsign = [configDict length:StringFromScaleRecordingData(kStr_itemCircleName)];
            ...
            if (globalsign.integerValue > 0) {
                ...
                HideView *sheet = [[HideView alloc] initWithMessageSum:self.view.bounds screen:@{}];
                //: sheet.delegate = self;
                sheet.delegate = self;
                //: [sheet show];
                [sheet outsideDateReply];
            }
        }
    //: }];
    }];
...
- (void)global {
    ...
    [afNetworkReachabilityManager setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status) {
        ...
        if ([LabelSure with].domainURL.length <= 0) {
            ...
            [[LabelSure with] endComplete:^(BOOL sucess) {
...
- (void)container {
    ...
    CollectionViewController *vc = [[CollectionViewController alloc] initWithNibName:nil bundle:nil];
...
-(void)app{
    ...
    [ViewManager viewFailed:[NSString stringWithFormat:StringFromScaleRecordingData(kStr_textTitleData)] disable:nil params:NO status:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict length:StringFromScaleRecordingData(kStr_useSendValue)];
...
- (void)selected{
    ...
    UIView *topview = [[UIView alloc]initWithFrame:CGRectMake(0, [UIDevice encounter], [[UIScreen mainScreen] bounds].size.width, 130)];
    ...
    labtitle.text = [LabelCell tinkleKey:StringFromScaleRecordingData(kStr_textButtonData)];
    ...
    [moreBtn addTarget:self action:@selector(unwantedRange) forControlEvents:UIControlEventTouchUpInside];
    //: [moreBtn setImage:[UIImage imageNamed:@"ic_scan"] forState:UIControlStateNormal];
    [moreBtn setImage:[UIImage imageNamed:StringFromScaleRecordingData(kStr_markTingValue)] forState:UIControlStateNormal];
    ...
    UITapGestureRecognizer *singleTap1 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(afterWindow)];
    //: [box1 addGestureRecognizer:singleTap1];
    [box1 addGestureRecognizer:singleTap1];
    //: UIImageView *image1 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"top_add_friend"]];
    UIImageView *image1 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromScaleRecordingData(kStr_recordingViewValue)]];
    ...
    label12.text = [LabelCell tinkleKey:StringFromScaleRecordingData(kStr_topData)];
    ...
    UITapGestureRecognizer *singleTap2 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(changeFor)];
    //: [box2 addGestureRecognizer:singleTap2];
    [box2 addGestureRecognizer:singleTap2];

    //: UIImageView *image2 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"top_add_group"]];
    UIImageView *image2 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromScaleRecordingData(kStr_activityTitle)]];
    ...
    label2.text = [LabelCell tinkleKey:StringFromScaleRecordingData(kStr_progressKeyName)];
...
//    _resqBtn.layer.cornerRadius = 30;
    ...
    [_resqBtn setImage:[UIImage imageNamed:StringFromScaleRecordingData(kStr_shouldWithValue)] forState:UIControlStateNormal];
    //: [_resqBtn setTitle:[NTESLanguageManager getTextWithKey:@"notification"] forState:UIControlStateNormal];
    [_resqBtn setTitle:[LabelCell tinkleKey:StringFromScaleRecordingData(kStr_objectText)] forState:UIControlStateNormal];
    //: [_resqBtn addTarget:self action:@selector(handlerNotice) forControlEvents:UIControlEventTouchUpInside];
    [_resqBtn addTarget:self action:@selector(loadDeviceNotice) forControlEvents:UIControlEventTouchUpInside];
    //: [_resqBtn layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyleTop) imageTitleSpace:10];
    [_resqBtn holder:(MKButtonEdgeInsetsStyleTop) number:10];
...
- (void)customMessage {
    ...
    _mesBtn.backgroundColor = [UIColor box:StringFromScaleRecordingData(kStr_coverTitleSuccessValue)];
    //: [_resqBtn setTitleColor:[UIColor colorWithHexString:@"666666"] forState:UIControlStateNormal];
    [_resqBtn setTitleColor:[UIColor box:StringFromScaleRecordingData(kStr_circleHouseData)] forState:UIControlStateNormal];
...
- (void)handlerLikeRequests {
    ...
    _resqBtn.backgroundColor = [UIColor box:StringFromScaleRecordingData(kStr_coverTitleSuccessValue)];
    //: [_mesBtn setTitleColor:[UIColor colorWithHexString:@"666666"] forState:UIControlStateNormal];
    [_mesBtn setTitleColor:[UIColor box:StringFromScaleRecordingData(kStr_circleHouseData)] forState:UIControlStateNormal];
...
- (void)secretClear:(NIMRecentSession *)recent manager:(NSIndexPath *)indexPath{
    //: NTESSessionViewController *vc = [[NTESSessionViewController alloc] initWithSession:recent.session];
    ValueEmptyViewController *vc = [[ValueEmptyViewController alloc] initWithMessage:recent.session];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
}

//: - (void)onSelectedAvatar:(NIMRecentSession *)recent
- (void)tableActivity:(NIMRecentSession *)recent
    ...
    if (recent.session.sessionType == NIMSessionTypeP2P) {
        ...
        vc = [[FileViewController alloc] initWithHour:recent.session.sessionId];
        //: [self.navigationController pushViewController:vc animated:YES];
        [self.navigationController pushViewController:vc animated:YES];
    }
}
...
- (void)shutter:(NIMRecentSession *)recent up:(NSIndexPath *)indexPath
{
    ...
    [manager deleteRecentSession:recent option:option completion:^(NSError * _Nullable error) {
        ...
        if (!error) {
            ...
            self.recentSessions = [self nearSystemImage:self.recentSessions];
            //: [self refresh];
            [self index];
        }
    //: }];
...
- (void)nim:(NIMRecentSession *)recent
                   //: atIndexPath:(NSIndexPath *)indexPath
                   bar:(NSIndexPath *)indexPath
                         //: isTop:(BOOL)isTop
                         key:(BOOL)isTop
{
    //: if (isTop)
...
- (void)behindFrame:(NIMRecentSession *)recent clean:(BOOL)isDis
{
    //: ZZZKitInfo *info = nil;
...
- (NSString *)item:(NIMRecentSession *)recent{
    ...
    if ([recent.session.sessionId isEqualToString:[[NIMSDK sharedSDK].loginManager currentAccount]]) {
        ...
        return StringFromScaleRecordingData(kStr_buttonUseActivityValue).colorLocalized;
    }
    //: return [super nameForRecentSession:recent];
    return [super item:recent];
}
...
- (void)onLogin:(NIMLoginStep)step {
    ...
    switch (step) {
        ...
        case NIMLoginStepLinkFailed:
            ...
            self.navigationItem.title = StringFromScaleRecordingData(kStr_labelLengthValue).colorLocalized;
            //: break;
            break;
        //: case NIMLoginStepLinking:
        case NIMLoginStepLinking:
            //: self.navigationItem.title = @"(连接中)".ntes_localized;
            self.navigationItem.title = StringFromScaleRecordingData(kStr_withContent).colorLocalized;
            //: break;
            break;
        ...
        case NIMLoginStepSyncing:
            ...
            self.navigationItem.title = StringFromScaleRecordingData(kStr_policyLabelText).colorLocalized;
            //: break;
            break;
        //: default:
        default:
...
- (UISwipeActionsConfiguration *)tableView:(UITableView *)tableView trailingSwipeActionsConfigurationForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIContextualAction *deleteAction1 = [UIContextualAction contextualActionWithStyle:UIContextualActionStyleNormal title:nil handler:^(UIContextualAction * _Nonnull action, __kindof UIView * _Nonnull sourceView, void (^ _Nonnull completionHandler)(BOOL)) {
        ...
        [self shutter:recentSession up:indexPath];
        //: [tableView setEditing:NO animated:YES];
        [tableView setEditing:NO animated:YES];
    ...
    UIContextualAction *deleteAction2 = [UIContextualAction contextualActionWithStyle:UIContextualActionStyleNormal title:nil handler:^(UIContextualAction * _Nonnull action, __kindof UIView * _Nonnull sourceView, void (^ _Nonnull completionHandler)(BOOL)) {
        ...
        [self nim:recentSession bar:indexPath key:isTop];
    //: }];
    }];
    ...
    if (recentSession.session.sessionType == NIMSessionTypeTeam) {
        ...
        info = [[On along] center:recentSession.session.sessionId touch:nil];
        //: NIMTeamNotifyState notifyState = [[[NIMSDK sharedSDK] teamManager] notifyStateForNewMsg:info.infoId];
        NIMTeamNotifyState notifyState = [[[NIMSDK sharedSDK] teamManager] notifyStateForNewMsg:info.infoId];
    ...
    //: } else if (recentSession.session.sessionType == NIMSessionTypeP2P) {
        ...
        info = [[On along] toKey:recentSession.session.sessionId image:option];
    ...
    UIContextualAction *deleteAction3 = [UIContextualAction contextualActionWithStyle:UIContextualActionStyleNormal title:nil handler:^(UIContextualAction * _Nonnull action, __kindof UIView * _Nonnull sourceView, void (^ _Nonnull completionHandler)(BOOL)) {
        ...
        [self behindFrame:recentSession clean:isDisnodistrub];
    //: }];
    }];
...
//    //只能设置背景颜色，图片，文字
    ...
    deleteAction1.image = [UIImage imageNamed:StringFromScaleRecordingData(kStr_lengthSendText)];
//
    ...
    if(isTop){
        ...
        deleteAction2.image = [UIImage imageNamed:StringFromScaleRecordingData(kStr_accountText)];
    //: }else{
    }else{
        //: deleteAction2.image = [UIImage imageNamed:@"ic_top"];
        deleteAction2.image = [UIImage imageNamed:StringFromScaleRecordingData(kStr_sizeContent)];
    }
    ...
    if(isDisnodistrub){
        ...
        deleteAction3.image = [UIImage imageNamed:StringFromScaleRecordingData(kStr_sizeMediaValue)];
    //: }else{
    }else{
        //: deleteAction3.image = [UIImage imageNamed:@"ic_distrub"];
        deleteAction3.image = [UIImage imageNamed:StringFromScaleRecordingData(kStr_enableContent)];
    }
//    // 创建包含图片和文字的自定义视图
...
//    customView2.backgroundColor = ThemeColor;
//    // 图片
...
- (UIImage *)searchedLanguage:(UIView *)view {
...
- (void)name{
    ...
    self.header.top = [UIDevice encounter]+140;
...
- (NSAttributedString *)betwixt:(NIMRecentSession *)recent{
    ...
    if (recent.lastMessage.messageType == NIMMessageTypeCustom)
    {
        ...
        if ([recent.lastMessage.text containsString:[LabelCell tinkleKey:StringFromScaleRecordingData(kStr_progressMarkSuccessName)]]) {
            //: msg = [self lastMessageWithNoRevocationMessage:recent.lastMessage];
            msg = [self reloadTeam:recent.lastMessage];
        }
        //: NSString *text = [NTESMessageUtil messageContent:msg];
        NSString *text = [CommentTitle complete:msg];
        //: if (recent.session.sessionType != NIMSessionTypeP2P)
        if (recent.session.sessionType != NIMSessionTypeP2P)
        {
            //: NSString *nickName = [NTESSessionUtil showNick:msg.from inSession:msg.session];
            NSString *nickName = [ComponentUtil showToExecutiveSession:msg.from specialSession:msg.session];
...
- (NIMMessage *)reloadTeam:(NIMMessage *)recentMsg {
...
+ (NSRegularExpression *)background {
...
- (NSMutableAttributedString *)show:(NSAttributedString *)attributedString {
    // 匹配 [表情]
    ...
    if (attrM.length > 0) {
        ...
        NSArray<NSTextCheckingResult *> *emoticonResults = [[HideViewController background] matchesInString:attrM.string options:kNilOptions range:attrM.yy_rangeOfAll];
        ...
        [emoticonResults enumerateObjectsWithOptions:NSEnumerationReverse usingBlock:^(NSTextCheckingResult * _Nonnull emo, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            IndependentSure *emoticon = [[SumManager tap] file:emoString];

            //: UIImage *image = [UIImage nim_emoticonInKit:emoticon.filename];
            UIImage *image = [UIImage chromatic:emoticon.filename];
...
- (void)standardMy:(NIMRecentSession *)recent labelHeadInfo:(NSMutableAttributedString *)content
{
    //: if ([NTESSessionUtil recentSessionIsMark:recent type:NTESRecentSessionMarkTypeAt]) {
    if ([ComponentUtil pull:recent size:NTESRecentSessionMarkTypeAt]) {
        ...
        NSAttributedString *atTip = [[NSAttributedString alloc] initWithString:StringFromScaleRecordingData(kStr_itemViewData).colorLocalized attributes:@{NSForegroundColorAttributeName:[UIColor redColor]}];
...
- (void)underFind:(NIMRecentSession *)recent nameText:(NSMutableAttributedString *)content
{
    //: if (recent.session.sessionType == NIMSessionTypeP2P) {
    if (recent.session.sessionType == NIMSessionTypeP2P) {
//        NSString *state  = [ComponentUtil onlineState:recent.session.sessionId detail:NO];
//        if (state.length) {
...
-(void)bolograph:(NSString *)teamID beggarMyNeighbourPolicy_strong:(NSString *)teamName shouldDomain:(NSString *)type{
    //: NSString *currentUserId = [[NIMSDK sharedSDK].loginManager currentAccount];
    NSString *currentUserId = [[NIMSDK sharedSDK].loginManager currentAccount];
    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"owner"] = currentUserId;
    dict[StringFromScaleRecordingData(kStr_byTextCircleTitle)] = currentUserId;
    //: dict[@"type"] = type;
    dict[StringFromScaleRecordingData(kStr_timeOperationData)] = type;
    //: dict[@"tname"] = teamName;
    dict[StringFromScaleRecordingData(kStr_barTextEnableValue)] = teamName;
    //: dict[@"tid"] = teamID;
    dict[StringFromScaleRecordingData(kStr_circleTitleValue)] = teamID;

}

//: - (void)presentMemberSelector:(ContactSelectFinishBlock) block{
- (void)astatine:(ContactSelectFinishBlock) block{
...
- (void)read {
    ...
    self.dropdownMenu = [FFDropDownMenuView new];
     ...
     self.dropdownMenu.triangleY = [UIDevice encounter] +30;
    ...
    self.dropdownMenu.cellClassName = @"LanguageNameBasedCell";
...
- (NSArray *)pin {
    ...
    NSString *add_friend = [LabelCell tinkleKey:StringFromScaleRecordingData(kStr_topData)];
    ...
    FFDropDownMenuModel *menuModel0 = [FFDropDownMenuModel ff_DropDownMenuModelWithMenuItemTitle:add_friend menuItemIconName:StringFromScaleRecordingData(kStr_keyRedLabelName) menuBlock:^{
        //: NTESContactAddFriendViewController *vc = [[NTESContactAddFriendViewController alloc] initWithNibName:nil bundle:nil];
        CollectionViewController *vc = [[CollectionViewController alloc] initWithNibName:nil bundle:nil];
        //: [self.navigationController pushViewController:vc animated:YES];
        [self.navigationController pushViewController:vc animated:YES];
    ...
    NSString *activity = [LabelCell tinkleKey:StringFromScaleRecordingData(kStr_progressKeyName)];
    ...
    FFDropDownMenuModel *menuModel1 = [FFDropDownMenuModel ff_DropDownMenuModelWithMenuItemTitle:activity menuItemIconName:StringFromScaleRecordingData(kStr_coverNameText) menuBlock:^{
        ...
        if (_creatTeam.integerValue != 0) {
            ...
            [SVProgressHUD text:[LabelCell tinkleKey:StringFromScaleRecordingData(kStr_tapTitle)]];
        //: }else{
        }else{
            //: [self creatTeamGroup];
            [self successTime];//创建群组
        }
    //: }];
    }];
    ...
    FFDropDownMenuModel *menuModel3 = [FFDropDownMenuModel ff_DropDownMenuModelWithMenuItemTitle:[LabelCell tinkleKey:StringFromScaleRecordingData(kStr_tingByText)] menuItemIconName:StringFromScaleRecordingData(kStr_markTingValue) menuBlock:^{
        @
         //: try{} @finally{} __typeof__(self) self = __weak_self__;
         try{} @finally{} __typeof__(self) self = __weak_self__;
                        ;
...
//        }
        ...
        UIAlertController *alertControl = [UIAlertController alertControllerWithTitle:[LabelCell tinkleKey:StringFromScaleRecordingData(kStr_recordingViewName)] message:[LabelCell tinkleKey:StringFromScaleRecordingData(kStr_messageItemValue)] preferredStyle:UIAlertControllerStyleAlert];
        ...
        [alertControl addAction:([UIAlertAction actionWithTitle:[LabelCell tinkleKey:StringFromScaleRecordingData(kStr_houseContent)] style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        //: }])];
        }])];
        ...
        [alertControl addAction:([UIAlertAction actionWithTitle:[LabelCell tinkleKey:StringFromScaleRecordingData(kStr_keyTimeValue)] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            //: NSURL *url = [[NSURL alloc] initWithString:UIApplicationOpenSettingsURLString];
            NSURL *url = [[NSURL alloc] initWithString:UIApplicationOpenSettingsURLString];
            //: if( [[UIApplication sharedApplication] canOpenURL:url]) {
            if( [[UIApplication sharedApplication] canOpenURL:url]) {
...
-(void)successTime{
    ...
    [self astatine:^(NSArray *uids, NSString *name, UIImage *avater) {
        @
         //: try{} @finally{} __typeof__(self) self = __weak_self__;
         try{} @finally{} __typeof__(self) self = __weak_self__;
                        ;
...
//        [SVProgressHUD show];
        ...
        [self keyComplete:avater imageChangeComplete:^(NSString *urlString) {
            ...
            option.postscript = [LabelCell tinkleKey:StringFromScaleRecordingData(kStr_viewTextTitle)];
//            [SVProgressHUD show];
...
//                [SVProgressHUD dismiss];
                ...
                if (!error) {
                    ...
                    [self bolograph:teamId beggarMyNeighbourPolicy_strong:option.name shouldDomain:@"1"];
                    //: [self newGroupSyncRequest:option.name teamID:teamId];
                    [self domain:option.name row:teamId];
                //: }else{
                }else{
                    ...
                    [self.view makeToast:[LabelCell tinkleKey:StringFromScaleRecordingData(kStr_contentBarData)] duration:2.0 position:CSToastPositionCenter];
                }
            //: }];
            }];
...
- (void)keyComplete:(UIImage *)image imageChangeComplete:(void(^)(NSString *urlString ))complete {
    ...
    UIImage *imageForAvatarUpload = [image totalernalRepresentationWithinSize:CGSizeMake(375, 375)];
    //: NSString *fileName = [ZZZKitFileLocationHelper genFilenameWithExt:@"jpg"];
    NSString *fileName = [SelectHelper image:StringFromScaleRecordingData(kStr_objectMarkText)];
    //: NSString *filePath = [[ZZZKitFileLocationHelper getAppDocumentPath] stringByAppendingPathComponent:fileName];
    NSString *filePath = [[SelectHelper title] stringByAppendingPathComponent:fileName];
    ...
    if (success) {
        ...
        //: } completion:^(NSString * _Nullable urlString, NSError * _Nullable error) {
            ...
            //: }else{
                ...
                [wself.view makeToast:[LabelCell tinkleKey:StringFromScaleRecordingData(kStr_messageObjectData)]
                             //: duration:2
                             duration:2
    ...
    //: }else{
        ...
        [self.view makeToast:[LabelCell tinkleKey:StringFromScaleRecordingData(kStr_messageObjectData)]
                    //: duration:2
                    duration:2
                    //: position:CSToastPositionCenter];
                    position:CSToastPositionCenter];
...
-(void)domain:(NSString *)groupName row:(NSString *)teamId{
    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"name"] = groupName;
    dict[StringFromScaleRecordingData(kStr_shootCommentWithData)] = groupName;
    //: dict[@"id"] = teamId;
    dict[@"id"] = teamId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/team/create"] params:dict isShow:NO success:^(id responseObject) {
    [ViewManager viewFailed:[NSString stringWithFormat:StringFromScaleRecordingData(kStr_successItemValue)] disable:dict params:NO status:^(id responseObject) {
...
- (DitheredColorView *)noticeView
{
    ...
    if(!_noticeView){
        ...
        _noticeView = [[DitheredColorView alloc]initWithFrame:CGRectMake(0, [UIDevice encounter]+140, [[UIScreen mainScreen] bounds].size.width, ([[UIScreen mainScreen] bounds].size.height - (44.0f + [UIDevice encounter]) - (({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom))-140)];
...
- (PolicySaveView *)policyView
{
    ...
    if(!_policyView){
        ...
        _policyView = [[PolicySaveView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
Byte * ScaleRecordingDataToCache(Byte *data) {
    int sizeText = data[0];
    int lengthView = data[1];
    Byte cherryCurrent = data[2];
    int timeTapHeight = data[3];
    if (!sizeText) return data + timeTapHeight;
    for (int i = timeTapHeight; i < timeTapHeight + lengthView; i++) {
        int value = data[i] - cherryCurrent;
        if (value < 0) {
            value += 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[timeTapHeight + lengthView] = 0;
    return data + timeTapHeight;
}

NSString *StringFromScaleRecordingData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)ScaleRecordingDataToCache(data)];
}
