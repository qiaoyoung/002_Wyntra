...
@implementation RadiogramName

//: - (id)initWithFilepath:(NSString *)path {
- (id)initWithPan:(NSString *)path {
    //: self = [super init];
    self = [super init];
...
+ (id)messageSuccess:(NSString *)path {
    //: if (path) {
    if (path) {
        //: return [[SGSoundEffect alloc] initWithFilepath:path];
        return [[RadiogramName alloc] initWithPan:path];
    }
    //: return nil;
    return nil;
}
