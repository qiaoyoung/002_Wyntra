...
#import "ShouldMedia.h"

//: @implementation UserManager
@implementation ShouldMedia

//判断是否登录
//: +(BOOL)isLogin
+(BOOL)screen
{
//    if ([AlongDefaults standardUserDefaults].user_id.length>0) {
//        return YES;
//    }else{
//        return NO;
//    }
...
+ (NSString *)record{
    ...
    NSString *userId = [AlongDefaults off].accid;
    //: return userId;
    return userId;
}
...
//    NSString *UserNo = emptyString([AlongDefaults standardUserDefaults].mobile);
//    return UserNo;
//}
//
//+ (NSString *)getHeaderImageUrl{
//    NSString *headImageUrl = emptyString([AlongDefaults standardUserDefaults].head_img);
//    return headImageUrl;
//}
//+ (NSString *)getNickName{
//    NSString *headImageUrl = emptyString([AlongDefaults standardUserDefaults].user_nickname);
//    return headImageUrl;
//}
//
//+ (void)callSevicePhoneNumber{
//    NSMutableString * string = [[ NSMutableString alloc] initWithFormat: @"tel:%@", [AlongDefaults standardUserDefaults].serverPhoneNumber];
//    [[ UIApplication sharedApplication] openURL:[ NSURL URLWithString:string]];
//}
//+ (NSString *)setPrefixURLWithURL:(NSString *)imageurl{
//    NSString *prefixStr = [AlongDefaults standardUserDefaults].prefixURL;
//
...
//    NSString *prefixStr = [AlongDefaults standardUserDefaults].prefixURL;
//    NSString *suffixStr = [AlongDefaults standardUserDefaults].thumbURL;
...
//+ (NSString *)getApikey{
//    NSString *apikey = emptyString([AlongDefaults standardUserDefaults].apikey);
//    return apikey;
//}
//
//+ (NSString *)getApisecret{
//    NSString *apisecret = emptyString([AlongDefaults standardUserDefaults].apisecret);
//    return apisecret;
//}
...
//        return;
//    }
//    [AlongDefaults standardUserDefaults].compId = [dict newStringValueForKey:@"compId"];
//    [AlongDefaults standardUserDefaults].orgId = [dict newStringValueForKey:@"orgId"];
//    [AlongDefaults standardUserDefaults].orgName = [dict newStringValueForKey:@"orgName"];
//
//
//    [AlongDefaults standardUserDefaults].longitude = [[dict newStringValueForKey:@"longitude"] doubleValue];
//    [AlongDefaults standardUserDefaults].latitude  = [[dict newStringValueForKey:@"latitude"] doubleValue];
//
//    [AlongDefaults standardUserDefaults].company_latitude = [dict newStringValueForKey:@"latitude"];
//    [AlongDefaults standardUserDefaults].company_longitude = [dict newStringValueForKey:@"longitude"];
//
//    [AlongDefaults standardUserDefaults].province = [dict newStringValueForKey:@"province"];
//    [AlongDefaults standardUserDefaults].city     = [dict newStringValueForKey:@"city"];
//    [AlongDefaults standardUserDefaults].district   = [dict newStringValueForKey:@"county"];
//    [AlongDefaults standardUserDefaults].address   = [dict newStringValueForKey:@"address"];
//
...
//            
//            [AlongDefaults standardUserDefaults].myName = [data newStringValueForKey:@"realName"];
//            [AlongDefaults standardUserDefaults].myHeadImg = [data newStringValueForKey:@"headImg"];
//            [AlongDefaults standardUserDefaults].myPosition = [data newStringValueForKey:@"position"];
//            [AlongDefaults standardUserDefaults].myCompanyName = [data newStringValueForKey:@"compName"];
//
//        }
