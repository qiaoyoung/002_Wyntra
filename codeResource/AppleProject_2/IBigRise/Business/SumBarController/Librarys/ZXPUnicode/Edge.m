...
//  github : https://github.com/biggercoffee/Edge
//
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        zxp_swizzleSelector(class, @selector(description), @selector(colorTop));
        //: zxp_swizzleSelector(class, @selector(descriptionWithLocale:), @selector(zxp_descriptionWithLocale:));
        zxp_swizzleSelector(class, @selector(descriptionWithLocale:), @selector(bies:));
        //: zxp_swizzleSelector(class, @selector(descriptionWithLocale:indent:), @selector(zxp_descriptionWithLocale:indent:));
        zxp_swizzleSelector(class, @selector(descriptionWithLocale:indent:), @selector(infoMy:cell:));
    //: });
    });
}
...
@implementation NSDictionary (Edge)
