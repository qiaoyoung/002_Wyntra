...
NSString * const kConst_contextValue = @"kAlertViewUserInfo";



//: @implementation UIView (KIAdditions)
@implementation UIView (Team)
...
- (void)setUserInfo:(id)userInfo {
    ...
    objc_setAssociatedObject(self, (__bridge const void *)(kConst_contextValue), userInfo, OBJC_ASSOCIATION_ASSIGN);
}

//: - (id)userInfo {
- (id)userInfo {
    //: return objc_getAssociatedObject(self, (__bridge const void *)(kViewUserInfo));
    return objc_getAssociatedObject(self, (__bridge const void *)(kConst_contextValue));
}
...
- (void)cutClean:(UITapGestureRecognizer *)sender {
...
- (UIViewController *)showInfo {
    ...
    return (UIViewController *)[self empty:self];
}
...
- (UIView *)unwishedShould:(Class)superViewClass{
    ...
    if (![superView isKindOfClass:superViewClass]) {
        ...
        superView = [superView unwishedShould:superViewClass];
    }
