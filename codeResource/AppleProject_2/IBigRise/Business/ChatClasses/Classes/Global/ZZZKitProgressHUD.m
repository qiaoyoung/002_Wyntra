...
//        NSString *bundleName = [[AppleProjectKit sharedKit] resourceBundleName];
//        NSURL *bundleURL = [[NSBundle bundleForClass:[ZZZKitProgressHUD class]] URLForResource:bundleName withExtension:nil];
//        
