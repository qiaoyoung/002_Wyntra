...
- (instancetype)initWithPast:(NSString *)userId
    ...
    if (self = [super init]) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(obscured:) name:kNIMTeamListDataTeamMembersChanged object:nil];
    }
    //: return self;
    return self;
}
...
- (NSArray *)pallet{
    ...
    option.session = _dataSource.terrace;
...
- (void)name:(UIAlertView *)alertView use:(NSInteger)buttonIndex{
