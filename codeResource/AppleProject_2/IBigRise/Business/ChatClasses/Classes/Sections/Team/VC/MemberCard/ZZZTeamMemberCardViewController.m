...
- (NSArray *)buildData{
    ...
    NSDictionary *userTypeItem = @{
                                   Title         : LangKey(@"activity_group_member_info2_shenfen"),//@"身份".nim_localized,
    ...
    NSDictionary *inviterAccidItem = @{
                                       Title         : LangKey(@"activity_group_member_info2_inviter"),//@"邀请人".nim_localized,
    ...
    NSDictionary *isMuteItem =  @{
                                  Title         : LangKey(@"group_member_info_activity_mute_msg"),//@"设置禁言".nim_localized,
...
- (void)onKickBtnClick:(id)sender {
    _kickAlertView = [[UIAlertView alloc] initWithTitle:@""
                                                message:LangKey(@"remove_member")//@"移出本群".nim_localized
                                               delegate:self
...
- (void)updateTeamNick
{
    _updateNickAlertView = [[UIAlertView alloc] initWithTitle:@""
                                                      message:LangKey(@"Modify_group_nickname")//@"修改群昵称".nim_localized
                                                     delegate:self
                                            cancelButtonTitle:LangKey(@"contact_tag_fragment_cancel")
                                            otherButtonTitles:LangKey(@"contact_tag_fragment_sure"), nil];
