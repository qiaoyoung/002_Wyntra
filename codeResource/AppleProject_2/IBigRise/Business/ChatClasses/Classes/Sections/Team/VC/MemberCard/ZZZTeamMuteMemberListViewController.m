...
- (void)refreshPage {
    self.navigationItem.title = [NSString stringWithFormat:@"%@(%zd)".nim_localized,LangKey(@"Members_of_the_banned"), _members.count];
}

- (void)setupUI {
    self.navigationItem.title = LangKey(@"Members_of_the_banned");//@"禁言成员".nim_localized;
