...
#import "RepresentationNameView.h"
...
@interface RepresentationNameView()
...
@implementation RepresentationNameView
...
- (void)text:(CollectionModel *)data
{
    ...
    if (self.model.message.deliveryState == NIMMessageDeliveryStateDelivering) {
        ...
        self.progressView.speedy = [[NIMSDK sharedSDK].chatManager messageTransportProgress:self.model.message];
    //: }else{
    }else{
