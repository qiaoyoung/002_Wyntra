...
NSString *StringFromEntertainData(Byte *data);


//: jpeg
Byte kStr_tianConvictViaData[] = {65, 4, 75, 4, 181, 187, 176, 178, 4};


//: png
Byte kStr_midstDamnText[] = {44, 3, 17, 4, 129, 127, 120, 218};


//: tiff
Byte kStr_playoffValue[] = {49, 4, 74, 9, 39, 203, 26, 243, 226, 190, 179, 176, 176, 183};


//: gif
Byte kStr_pointShouldText[] = {20, 3, 14, 8, 213, 135, 182, 170, 117, 119, 116, 65};


//: yyyy-MM-dd HH:mm:ss
Byte kStr_fieldTextValue[] = {30, 19, 83, 4, 204, 204, 204, 204, 128, 160, 160, 128, 183, 183, 115, 155, 155, 141, 192, 192, 141, 198, 198, 253};
...
- (UIImage *)magnitudeTo:(BOOL)isHorizontal {
...
- (UIImage *)text:(CGFloat)width {
    ...
    return [self sight:width withKeyHeight:height];
}
...
- (UIImage *)tingHeight:(CGFloat)heigh {
    ...
    return [self sight:width withKeyHeight:heigh];
}
...
- (UIImage *)bar {
    ...
    [df setDateFormat:StringFromEntertainData(kStr_fieldTextValue)];
    ...
    return [self size:dateString
               //: textColor:[UIColor blackColor]
               full:[UIColor blackColor]
                    //: font:[UIFont boldSystemFontOfSize:16.0f]
                    primaryColor:[UIFont boldSystemFontOfSize:16.0f]
                   //: point:CGPointMake(self.size.width-size.width-10, self.size.height-size.height-10)];
                   buttonMagnitude:CGPointMake(self.size.width-size.width-10, self.size.height-size.height-10)];
...
+ (NSString *) should:(NSData *)data{
    ...
    switch (c) {
        ...
        case 0xFF:
            //: return @"jpeg";
            return StringFromEntertainData(kStr_tianConvictViaData);
        //: case 0x89:
        case 0x89:
            //: return @"png";
            return StringFromEntertainData(kStr_midstDamnText);
        //: case 0x47:
        case 0x47:
            //: return @"gif";
            return StringFromEntertainData(kStr_pointShouldText);
        //: case 0x49:
        case 0x49:
        //: case 0x4D:
        case 0x4D:
            //: return @"tiff";
            return StringFromEntertainData(kStr_playoffValue);
    }
    //: return @"";
    return @"";
}
...
- (UIImage *)info:(NSUInteger)maxLength{
    ...
    NSData *compressData = [self fileTime:maxLength*1024];
...
-(NSData *)fileTime:(double)maxLength{
    // Compress by quality
...
Byte * EntertainDataToCache(Byte *data) {
    int oil = data[0];
    int thick = data[1];
    Byte truth = data[2];
    int urge = data[3];
    if (!oil) return data + urge;
    for (int i = urge; i < urge + thick; i++) {
...
NSString *StringFromEntertainData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)EntertainDataToCache(data)];
}
