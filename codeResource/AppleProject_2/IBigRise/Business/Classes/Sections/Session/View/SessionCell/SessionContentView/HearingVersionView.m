...
@implementation HearingVersionView
...
- (void)text:(CollectionModel *)data
{
    ...
    if ([attachment isKindOfClass:[TeamAttachment class]]) {
        ...
        self.imageView.image = [attachment show];
...
- (UIImage *)withCell:(UIControlState)state colorUnwantedVisualizationStateGestureBubble:(BOOL)outgoing{
    ...
    return [super withCell:state colorUnwantedVisualizationStateGestureBubble:outgoing];
}
