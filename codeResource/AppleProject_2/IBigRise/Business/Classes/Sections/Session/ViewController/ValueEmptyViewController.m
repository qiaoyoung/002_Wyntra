...
- (void)backgroundTing:(VagaryItem *)item
{
...
- (void)dateLength:(VagaryItem *)item
{
...
- (void)titleInterval:(VagaryItem *)item
{
    //: NIMMessage *message = [self messageForMenu];
    NIMMessage *message = [self messageForMenu];
...
- (void)valueUnpin:(VagaryItem *)item
{
    //: NIMMessage *message = [self messageForMenu];
    NIMMessage *message = [self messageForMenu];
...
- (void)holderEnableName:(NIMMessage *)message
{
...
- (void)colorDown:(NIMMessage *)message
{
...
- (void)customSend:(NIMMessage *)message
{
   //普通的自定义消息点击事件可以在这里做哦~
