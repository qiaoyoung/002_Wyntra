...
@interface BringForthDoing : NSObject
...
@interface SignalingSession : NSObject
...
- (BringForthDoing *)inside:(NSMutableArray <NIMMessage *> *)messages
                                          ...
                                          canText:(_Nullable NTESMergeForwardProcess)process
                                       //: completion:(_Nullable NTESMergeForwardResult)completion;
                                       process:(_Nullable NTESMergeForwardResult)completion;
