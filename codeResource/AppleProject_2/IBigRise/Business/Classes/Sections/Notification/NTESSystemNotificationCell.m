...
//@property (nonatomic,strong) IBOutlet ZZZAvatarImageView *avatarImageView;
@end
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = TextColor_4;
...
- (UIButton *)acceptButton {
    if (!_acceptButton) {
        ...
        _acceptButton.frame = CGRectMake(SCREEN_WIDTH - 15 -32, 21, 32, 32);
    ...
    if(hideActionButton) {
        ...
        switch (self.notification.handleStatus) {
            ...
            case NotificationHandleTypeOutOfDate:
                ...
                break;
            default:
                self.handleInfoLabel.text = @"已读".nim_localized;
                break;
        }
    } else {
...
//    self.avatarImageView = [[ZZZAvatarImageView alloc] initWithFrame:CGRectMake(0, 0, 40, 40)];
//    [self.contentView addSubview:self.avatarImageView];
//
