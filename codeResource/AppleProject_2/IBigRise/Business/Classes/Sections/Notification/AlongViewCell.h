...
@interface AlongViewCell : UITableViewCell
...
@property (weak, nonatomic) id<SystemWith> actionDelegate;
//: - (void)update:(NIMSystemNotification *)notification;
- (void)providerImage:(NIMSystemNotification *)notification;
//: @end
@end