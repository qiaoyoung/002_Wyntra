...
static CGFloat const kConst_mediaData = 3;

//: @implementation YasicClipAreaLayer
@implementation SuggestLayer
...
- (void)drawInContext:(CGContextRef)ctx
{
    ...
    CGContextSetLineWidth(ctx, kConst_mediaData);
...
- (void)title:(NSInteger)cropAreaLeft refer:(NSInteger)cropAreaTop nameComplete:(NSInteger)cropAreaRight user:(NSInteger)cropAreaBottom
{
    //: _cropAreaLeft = cropAreaLeft;
    _cropAreaLeft = cropAreaLeft;
    //: _cropAreaRight = cropAreaRight;
