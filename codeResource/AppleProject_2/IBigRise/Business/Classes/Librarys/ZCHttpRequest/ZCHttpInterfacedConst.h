...
extern __attribute__((visibility ("default"))) NSString *const kConst_makeData;/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const kConst_sizeExcessValue;/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const kConst_teamTapTitle;/** 即时聊天*/
