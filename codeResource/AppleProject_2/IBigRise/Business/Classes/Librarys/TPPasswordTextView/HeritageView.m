...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [textField addTarget:self action:@selector(voiced:) forControlEvents:UIControlEventEditingChanged];
...
- (void)voiced:(UITextField *)textField {
