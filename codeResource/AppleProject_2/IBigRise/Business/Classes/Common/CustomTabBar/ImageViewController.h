...
@protocol EnterContainer <UITabBarControllerDelegate>
...
@property (nonatomic, strong, readonly) CountView *customTabBar;
//: @property (nonatomic, strong, readonly) UIView *containerView;
@property (nonatomic, strong, readonly) UIView *containerView;
//: @property (nonatomic, copy) NSArray<__kindof UIViewController *> *viewControllers;
@property (nonatomic, copy) NSArray<__kindof UIViewController *> *viewControllers;
//: @property (nonatomic, weak, nullable) id<CustomTabBarControllerDelegate> delegate;
@property (nonatomic, weak, nullable) id<EnterContainer> delegate;
...
- (void)value:(nullable NSString *)badgeValue send:(NSInteger)index;
