...
#import "UINavigationBar+Value.h"
...
@implementation UINavigationBar (Value)
...
+ (void)load{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        swizzling_exchangeMethod([UINavigationBar class] ,@selector(layoutSubviews), @selector(schemeIn));
    //: });
    });
}
