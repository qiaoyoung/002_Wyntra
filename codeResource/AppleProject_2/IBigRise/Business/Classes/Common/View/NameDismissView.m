...
@implementation NameDismissView
...
+ (instancetype)session:(NSString *)badgeValue{
    ...
    NameDismissView *instance = [[NameDismissView alloc] init];
    //: instance.frame = [instance frameWithStr:badgeValue];
    instance.frame = [instance label:badgeValue];
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([[self badgeValue] length]) {
        ...
        [self itemBackground:rect need:context];
    //: }else{
    }else{
        //: [self drawWithOutContent:rect context:context];
        [self color:rect contextOfUseDragCollectionDownWith:context];
    }
...
- (void)setBadgeValue:(NSString *)badgeValue {
    ...
    self.frame = [self label:badgeValue];
...
- (CGSize)lastStr:(NSString *)badgeValue{
...
- (CGRect)label:(NSString *)badgeValue{
    //: CGSize badgeSize = [self badgeSizeWithStr:badgeValue];
    CGSize badgeSize = [self lastStr:badgeValue];
...
- (void)itemBackground:(CGRect)rect need:(CGContextRef)context{
...
- (void)color:(CGRect)rect contextOfUseDragCollectionDownWith:(CGContextRef)context{
    //: CGRect bodyFrame = self.bounds;
    CGRect bodyFrame = self.bounds;
