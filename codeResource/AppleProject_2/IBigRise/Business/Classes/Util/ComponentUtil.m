...
NSString *StringFromPlayoffData(Byte *data);        


//: wrong_password
Byte kStr_entertainText[] = {19, 14, 51, 8, 86, 170, 50, 194, 68, 63, 60, 59, 52, 44, 61, 46, 64, 64, 68, 60, 63, 49, 186};


//: Web
Byte kStr_tunCarveTitle[] = {41, 3, 9, 9, 253, 108, 201, 3, 103, 78, 92, 89, 140};


//: Wednesday
Byte kStr_easterName[] = {75, 9, 58, 14, 230, 251, 122, 217, 49, 232, 245, 185, 129, 97, 29, 43, 42, 52, 43, 57, 42, 39, 63, 166};


//: logged_another_device
Byte kStr_tapPayerEyebrowData[] = {15, 21, 74, 8, 177, 165, 231, 135, 34, 37, 29, 29, 27, 26, 21, 23, 36, 37, 42, 30, 27, 40, 21, 26, 27, 44, 31, 25, 27, 234};


//: postscript
Byte kStr_crowdedData[] = {98, 10, 35, 10, 65, 90, 12, 129, 128, 231, 77, 76, 80, 81, 80, 64, 79, 70, 77, 81, 113};


//: Mac
Byte kStr_eyebrowPlatData[] = {2, 3, 32, 14, 89, 56, 184, 146, 96, 204, 3, 90, 178, 118, 45, 65, 67, 239};


//: %zd-%zd-%zd
Byte kStr_sharpText[] = {29, 11, 22, 5, 97, 15, 100, 78, 23, 15, 100, 78, 23, 15, 100, 78, 88};


//: message_opposite
Byte kStr_objectSightName[] = {87, 16, 8, 5, 155, 101, 93, 107, 107, 89, 95, 93, 87, 103, 104, 104, 103, 107, 97, 108, 93, 144};


//: message_online
Byte kStr_tartMannerText[] = {58, 14, 87, 7, 97, 78, 217, 22, 14, 28, 28, 10, 16, 14, 8, 24, 23, 21, 18, 23, 14, 78};


//: online_state_event_manager_on_line_busy
Byte kStr_layerMathContent[] = {75, 39, 41, 12, 227, 224, 213, 169, 162, 224, 199, 233, 70, 69, 67, 64, 69, 60, 54, 74, 75, 56, 75, 60, 54, 60, 77, 60, 69, 75, 54, 68, 56, 69, 56, 62, 60, 73, 54, 70, 69, 54, 67, 64, 69, 60, 54, 57, 76, 74, 80, 107};


//: day_pm
Byte kStr_therePayerTitle[] = {59, 6, 27, 6, 85, 167, 73, 70, 94, 68, 85, 82, 189};


//: iOS
Byte kStr_pantContent[] = {57, 3, 12, 11, 30, 147, 229, 212, 65, 100, 208, 93, 67, 71, 125};


//: group_member_info_activity_team_admin
Byte kStr_sectorRedValue[] = {29, 37, 21, 14, 255, 165, 225, 198, 87, 63, 142, 144, 19, 190, 82, 93, 90, 96, 91, 74, 88, 80, 88, 77, 80, 93, 74, 84, 89, 81, 90, 74, 76, 78, 95, 84, 97, 84, 95, 100, 74, 95, 80, 76, 88, 74, 76, 79, 88, 84, 89, 70};


//: wee_hours
Byte kStr_inventGagValue[] = {88, 9, 33, 7, 93, 2, 9, 86, 68, 68, 62, 71, 78, 84, 81, 82, 124};


//: group_member_info_activity_team_creator
Byte kStr_competitorData[] = {94, 39, 45, 8, 41, 91, 51, 94, 58, 69, 66, 72, 67, 50, 64, 56, 64, 53, 56, 69, 50, 60, 65, 57, 66, 50, 52, 54, 71, 60, 73, 60, 71, 76, 50, 71, 56, 52, 64, 50, 54, 69, 56, 52, 71, 66, 69, 104};


//: before_yesterday
Byte kStr_stairsImageCommentData[] = {1, 16, 56, 11, 221, 149, 154, 248, 157, 215, 166, 42, 45, 46, 55, 58, 45, 39, 65, 45, 59, 60, 45, 58, 44, 41, 65, 166};


//: Sunday
Byte kStr_hemeCreaseValue[] = {3, 6, 66, 12, 48, 238, 110, 157, 114, 122, 225, 235, 17, 51, 44, 34, 31, 55, 250};


//: Friday
Byte kStr_optimisticLysisData[] = {39, 6, 88, 14, 214, 108, 110, 190, 130, 50, 18, 127, 159, 68, 238, 26, 17, 12, 9, 33, 90};


//: Tuesday
Byte kStr_fingerAccurateText[] = {80, 7, 53, 5, 148, 31, 64, 48, 62, 47, 44, 68, 238};


//: please_try_again
Byte kStr_mutualData[] = {57, 16, 3, 13, 145, 40, 97, 255, 225, 127, 44, 121, 135, 109, 105, 98, 94, 112, 98, 92, 113, 111, 118, 92, 94, 100, 94, 102, 107, 130};


//: day_am
Byte kStr_easterContent[] = {97, 6, 37, 10, 234, 60, 9, 63, 35, 28, 63, 60, 84, 58, 60, 72, 162};


//: retracted_message
Byte kStr_cramData[] = {52, 17, 67, 7, 230, 59, 61, 47, 34, 49, 47, 30, 32, 49, 34, 33, 28, 42, 34, 48, 48, 30, 36, 34, 187};


//: online_state_event_manager_off_line
Byte kStr_gagText[] = {12, 35, 4, 14, 172, 202, 53, 114, 145, 133, 82, 227, 94, 2, 107, 106, 104, 101, 106, 97, 91, 111, 112, 93, 112, 97, 91, 97, 114, 97, 106, 112, 91, 105, 93, 106, 93, 99, 97, 110, 91, 107, 98, 98, 91, 104, 101, 106, 97, 41};


//: message_helper_you
Byte kStr_accountLatterContent[] = {8, 18, 1, 14, 205, 244, 70, 211, 211, 65, 59, 254, 112, 65, 108, 100, 114, 114, 96, 102, 100, 94, 103, 100, 107, 111, 100, 113, 94, 120, 110, 116, 57};


//: Thursday
Byte kStr_mediaUntilValue[] = {61, 8, 18, 12, 153, 43, 227, 159, 32, 169, 245, 197, 66, 86, 99, 96, 97, 82, 79, 103, 206};


//: Android
Byte kStr_redMannerText[] = {21, 7, 34, 6, 167, 132, 31, 76, 66, 80, 77, 71, 66, 95};


//: login_failure
Byte kStr_piracyRapidMoveValue[] = {66, 13, 59, 7, 133, 255, 143, 49, 52, 44, 46, 51, 36, 43, 38, 46, 49, 58, 55, 42, 71};


//: yesterday
Byte kStr_fashionWithSayValue[] = {54, 9, 99, 5, 81, 22, 2, 16, 17, 2, 15, 1, 254, 22, 46};


//: Monday
Byte kStr_totalSendContent[] = {24, 6, 8, 14, 117, 62, 70, 100, 196, 98, 44, 125, 156, 34, 69, 103, 102, 92, 89, 113, 95};


//: day_night
Byte kStr_percentageEventWithTitle[] = {74, 9, 65, 14, 170, 11, 220, 65, 83, 65, 43, 131, 128, 197, 35, 32, 56, 30, 45, 40, 38, 39, 51, 106};


//: Saturday
Byte kStr_stockCurData[] = {9, 8, 6, 10, 9, 99, 189, 3, 254, 103, 77, 91, 110, 111, 108, 94, 91, 115, 176};
...
double kConst_boxTitle = 24*60*60; //一天的秒数

//: static NSString *const NTESRecentSessionAtMark = @"NTESRecentSessionAtMark";
static NSString *const kConst_beginName = @"NTESRecentSessionAtMark";
//: static NSString *const NTESRecentSessionTopMark = @"NTESRecentSessionTopMark";
static NSString *const kConst_nameApproachValue = @"NTESRecentSessionTopMark";
...
+(BOOL)earlier:(NSTimeInterval)currentTime orientationExtra:(NSDateComponents*)older
{
...
+(NSString*)sum:(NSInteger)dayOfWeek
{
    //: static NSDictionary *daysOfWeekDict = nil;
    static NSDictionary *daysOfWeekDict = nil;
    //: daysOfWeekDict = @{@(1):[NTESLanguageManager getTextWithKey:@"Sunday"],//@"星期日".ntes_localized,
    daysOfWeekDict = @{@(1):[LabelCell tinkleKey:StringFromPlayoffData(kStr_hemeCreaseValue)],//@"星期日".ntes_localized,
                       //: @(2):[NTESLanguageManager getTextWithKey:@"Monday"],//@"星期一".ntes_localized,
                       @(2):[LabelCell tinkleKey:StringFromPlayoffData(kStr_totalSendContent)],//@"星期一".ntes_localized,
                       //: @(3):[NTESLanguageManager getTextWithKey:@"Tuesday"],//@"星期二".ntes_localized,
                       @(3):[LabelCell tinkleKey:StringFromPlayoffData(kStr_fingerAccurateText)],//@"星期二".ntes_localized,
                       //: @(4):[NTESLanguageManager getTextWithKey:@"Wednesday"],//@"星期三".ntes_localized,
                       @(4):[LabelCell tinkleKey:StringFromPlayoffData(kStr_easterName)],//@"星期三".ntes_localized,
                       //: @(5):[NTESLanguageManager getTextWithKey:@"Thursday"],//@"星期四".ntes_localized,
                       @(5):[LabelCell tinkleKey:StringFromPlayoffData(kStr_mediaUntilValue)],//@"星期四".ntes_localized,
                       //: @(6):[NTESLanguageManager getTextWithKey:@"Friday"],//@"星期五".ntes_localized,
                       @(6):[LabelCell tinkleKey:StringFromPlayoffData(kStr_optimisticLysisData)],//@"星期五".ntes_localized,
                       //: @(7):[NTESLanguageManager getTextWithKey:@"Saturday"]};
                       @(7):[LabelCell tinkleKey:StringFromPlayoffData(kStr_stockCurData)]};//@"星期六".ntes_localized,};
...
+(NSDateComponents*)read:(NSTimeInterval)messageTime size:(NSCalendarUnit)components
{
...
+(NSString*)toDetail:(NSTimeInterval) msglastTime view:(BOOL)showDetail
{
    ...
    result = [ComponentUtil loadNumbererval:hour with:msgDateComponents.minute];
    //: if (hour > 12)
    if (hour > 12)
    {
        //: hour = hour - 12;
    ...
    else if(nowDateComponents.day == (msgDateComponents.day+1))//昨天
    {
        ...
        result = showDetail? [[NSString alloc] initWithFormat:@"%@%@ %zd:%02d",[LabelCell tinkleKey:StringFromPlayoffData(kStr_fashionWithSayValue)], result,hour,(int)msgDateComponents.minute] : [LabelCell tinkleKey:StringFromPlayoffData(kStr_fashionWithSayValue)];//昨天
    }
    ...
    else if(nowDateComponents.day == (msgDateComponents.day+2)) //前天
    {
        ...
        result = showDetail? [[NSString alloc] initWithFormat:@"%@%@ %zd:%02d",[LabelCell tinkleKey:StringFromPlayoffData(kStr_stairsImageCommentData)], result,hour,(int)msgDateComponents.minute] : [LabelCell tinkleKey:StringFromPlayoffData(kStr_stairsImageCommentData)];//@"前天".ntes_localized;
    }
    //: else if([nowDate timeIntervalSinceDate:msgDate] < 7 * OnedayTimeIntervalValue)
    else if([nowDate timeIntervalSinceDate:msgDate] < 7 * kConst_boxTitle)//一周内
    {
        //: NSString *weekDay = [NTESSessionUtil weekdayStr:msgDateComponents.weekday];
        NSString *weekDay = [ComponentUtil sum:msgDateComponents.weekday];
    ...
    else//显示日期
    {
        ...
        NSString *day = [NSString stringWithFormat:StringFromPlayoffData(kStr_sharpText), msgDateComponents.year, msgDateComponents.month, msgDateComponents.day];
...
+ (NSString *)loadNumbererval:(NSInteger)time with:(NSInteger)minute
{
    ...
    if (totalMin > 0 && totalMin <= 5 * 60)
    {
        ...
        showPeriodOfTime = [LabelCell tinkleKey:StringFromPlayoffData(kStr_inventGagValue)];//@"凌晨".ntes_localized;
    }
    //: else if (totalMin > 5 * 60 && totalMin < 12 * 60)
    else if (totalMin > 5 * 60 && totalMin < 12 * 60)
    {
        //: showPeriodOfTime = [NTESLanguageManager getTextWithKey:@"day_am"];
        showPeriodOfTime = [LabelCell tinkleKey:StringFromPlayoffData(kStr_easterContent)];//@"上午".ntes_localized;
    }
    //: else if (totalMin >= 12 * 60 && totalMin <= 18 * 60)
    else if (totalMin >= 12 * 60 && totalMin <= 18 * 60)
    {
        //: showPeriodOfTime = [NTESLanguageManager getTextWithKey:@"day_pm"];
        showPeriodOfTime = [LabelCell tinkleKey:StringFromPlayoffData(kStr_therePayerTitle)];//@"下午".ntes_localized;
    }
    //: else if ((totalMin > 18 * 60 && totalMin <= (23 * 60 + 59)) || totalMin == 0)
    else if ((totalMin > 18 * 60 && totalMin <= (23 * 60 + 59)) || totalMin == 0)
    {
        //: showPeriodOfTime = [NTESLanguageManager getTextWithKey:@"day_night"];
        showPeriodOfTime = [LabelCell tinkleKey:StringFromPlayoffData(kStr_percentageEventWithTitle)];//@"晚上".ntes_localized;
    }
...
+ (NSDictionary *)title:(NSString *)jsonString
{
    ...
    return [ComponentUtil pinPastNameAccountingDataMagnitudeerval:data];
}
...
+ (NSString *)viewLocal:(NSString *)postscript {
    ...
    NSString *tip = [LabelCell tinkleKey:StringFromPlayoffData(kStr_accountLatterContent)];//@"你".ntes_localized;
    //: NSString *msg = [NSString stringWithFormat:@"%@%@", tip,[NTESLanguageManager getTextWithKey:@"retracted_message"]];
    NSString *msg = [NSString stringWithFormat:@"%@%@", tip,[LabelCell tinkleKey:StringFromPlayoffData(kStr_cramData)]];
    ...
    if (postscript.length != 0) {
        ...
        msg = [NSString stringWithFormat:@"%@%@.%@:%@", tip,[LabelCell tinkleKey:StringFromPlayoffData(kStr_cramData)],[LabelCell tinkleKey:StringFromPlayoffData(kStr_crowdedData)], postscript];
    }
    //: return msg;
    return msg;
}
...
+ (NSString *)lockUpOption:(NIMRevokeMessageNotification *)notification
{
    //: NSString *tip = @"";
    NSString *tip = @"";
    //: do {
    do {
        ...
        if (!notification || ![notification isKindOfClass:[NIMRevokeMessageNotification class]]) {
            ...
            tip = [LabelCell tinkleKey:StringFromPlayoffData(kStr_accountLatterContent)];//@"你".ntes_localized;
            //: break;
            break;
        }
    ...
    if (notification.postscript.length != 0) {
        ...
        msg = [NSString stringWithFormat:@"%@ %@.%@:%@", tip,[LabelCell tinkleKey:StringFromPlayoffData(kStr_cramData)],[LabelCell tinkleKey:StringFromPlayoffData(kStr_crowdedData)], notification.postscript];
    }
    //: return msg;
    return msg;
}
...
+ (NSString *)size:(NIMRevokeMessageNotification *)notification {
    ...
    return fromMe ? [LabelCell tinkleKey:StringFromPlayoffData(kStr_accountLatterContent)]: [LabelCell tinkleKey:StringFromPlayoffData(kStr_objectSightName)];//@"对方".ntes_localized;
}
...
+ (NSString *)dedication:(NIMRevokeMessageNotification *)notification {
    ...
    do {
        ...
        if (revokeBySender && fromMe) {
            ...
            tipTitle = [LabelCell tinkleKey:StringFromPlayoffData(kStr_accountLatterContent)];//@"你".ntes_localized;
            //: break;
            break;
        }
        ...
        MagnitudeCommentInfo *info = [[On along] toKey:(revokeBySender ? fromUid : operatorUid) image:option];
        ...
        if (member.type == NIMTeamMemberTypeOwner) {
            ...
            tipTitle = [[LabelCell tinkleKey:StringFromPlayoffData(kStr_competitorData)] stringByAppendingString:info.showName];//@"群主".ntes_localized
        }
        //: else if (member.type == NIMTeamMemberTypeManager) {
            ...
            tipTitle = [[LabelCell tinkleKey:StringFromPlayoffData(kStr_sectorRedValue)] stringByAppendingString:info.showName];//@"管理员".ntes_localized
        }
    //: } while (false);
    } while (false);
...
+ (BOOL)wateringPot:(NIMMessage *)message
{
    ...
    if ([messageObject isKindOfClass:[NIMCustomObject class]])
    {
        ...
        id<ShouldQuantityComment> attach = (id<ShouldQuantityComment>)[(NIMCustomObject *)message.messageObject attachment];
        //: return [attach canBeForwarded];
        return [attach tapForwarded];
    }
...
+ (BOOL)straddle:(NIMMessage *)message
{
    ...
    BOOL canRevokeMessageByRole = [self red:message];
...
+ (void)top:(NIMSession *)session with:(NTESRecentSessionMarkType)type
{
    ...
    if (recent)
    {
        ...
        NSString *key = [ComponentUtil image:type];
...
+ (NSString *)image:(NTESRecentSessionMarkType)type
{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        keys = @{
                 ...
                 @(NTESRecentSessionMarkTypeAt) : kConst_beginName,
                 //: @(NTESRecentSessionMarkTypeTop) : NTESRecentSessionTopMark
                 @(NTESRecentSessionMarkTypeTop) : kConst_nameApproachValue
                 //: };
                 };
    //: });
    });
...
+ (NSString *)baseballTeam:(NSString *)userId location:(BOOL)detail
{
    ...
    if (![InputManager pressed] || [[NIMSDK sharedSDK].loginManager.currentAccount isEqualToString:userId])
    {
    ...
    NSDictionary *dict = [[InputManager pressed] woof:NIMSubscribeSystemEventTypeOnline];
    ...
    if ([info isKindOfClass:[NIMSubscribeOnlineInfo class]] && info.senderClientTypes.count)
    {
        ...
        NIMLoginClientType client = [self show:info.senderClientTypes];
        ...
        switch (event.value) {
            ...
            case NIMSubscribeEventOnlineValueDisconnected:
            {
                ...
                state = [self equip:ext listDetail:client color:detail];
            }
                //: break;
                break;
            ...
            default:
            {
                ...
                NSString *clientName = [self blue:client];
                //: state = [NSString stringWithFormat:@"%@ %@", clientName, [NTESLanguageManager getTextWithKey:@"message_online"]];
                state = [NSString stringWithFormat:@"%@ %@", clientName, [LabelCell tinkleKey:StringFromPlayoffData(kStr_tartMannerText)]];
                //: break;
                break;
            }
        }
...
+ (NIMLoginClientType)show:(NSArray *)senderClientTypes
{
...
+ (NSString *)blue:(NIMLoginClientType )client
{
    ...
    NSDictionary *formats = @{
                              ...
                              @(NIMLoginClientTypemacOS) : StringFromPlayoffData(kStr_eyebrowPlatData),
                              //: @(NIMLoginClientTypeiOS): @"iOS",
                              @(NIMLoginClientTypeiOS): StringFromPlayoffData(kStr_pantContent),
                              //: @(NIMLoginClientTypeAOS): @"Android",
                              @(NIMLoginClientTypeAOS): StringFromPlayoffData(kStr_redMannerText),
                              //: @(NIMLoginClientTypeWeb): @"Web",
                              @(NIMLoginClientTypeWeb): StringFromPlayoffData(kStr_tunCarveTitle),
...
+ (NSString *)equip:(NSString *)ext listDetail:(NIMLoginClientType)client color:(BOOL)detail
{
    //: NSString *clientName = [self resolveOnlineClientName:client];
    NSString *clientName = [self blue:client];
    //: NSString *state = [NSString stringWithFormat:@"%@ %@",clientName,[NTESLanguageManager getTextWithKey:@"message_online"]];
    NSString *state = [NSString stringWithFormat:@"%@ %@",clientName,[LabelCell tinkleKey:StringFromPlayoffData(kStr_tartMannerText)]];//@"在线".ntes_localized
    //: NSDictionary *dict = [ext nimkit_jsonDict];
    NSDictionary *dict = [ext close];
    //: if (dict) {
    if (dict) {

        //: NSString *netState = [[NTESDevice currentDevice] networkStatus:[dict jsonInteger:NTESSubscribeNetState]];
        NSString *netState = [[CenterValue displayEnable] metadata:[dict plumbSum:kConst_stateContent]];
        //: NTESOnlineState onlineState = [dict jsonInteger:NTESSubscribeOnlineState];
        NTESOnlineState onlineState = [dict plumbSum:kConst_modeData];
        //: switch (onlineState) {
        switch (onlineState) {
            ...
            case NTESOnlineStateNormal:
            {
                    ...
                    client == NIMLoginClientTypemacOS)
                {
                    ...
                    return [NSString stringWithFormat:@"%@ %@",clientName,[LabelCell tinkleKey:StringFromPlayoffData(kStr_tartMannerText)]];//@"在线".ntes_localized
                }
                //: else
                else
                {
                    ...
                    if (detail)
                    {
                        ...
                        return [NSString stringWithFormat:@"%@ - %@ %@",clientName,netState,[LabelCell tinkleKey:StringFromPlayoffData(kStr_tartMannerText)]];//@"在线".ntes_localized
                    }
                    //: else
                    else
                    {
                        //: return [NSString stringWithFormat:@"%@ %@",netState,[NTESLanguageManager getTextWithKey:@"message_online"]];
                        return [NSString stringWithFormat:@"%@ %@",netState,[LabelCell tinkleKey:StringFromPlayoffData(kStr_tartMannerText)]];//@"在线".ntes_localized
                    }
                }
            }
            ...
            case NTESOnlineStateBusy:
                ...
                return [LabelCell tinkleKey:StringFromPlayoffData(kStr_layerMathContent)];//@"忙碌".ntes_localized;
            //: case NTESOnlineStateLeave:
            case NTESOnlineStateLeave:
                //: return [NTESLanguageManager getTextWithKey:@"online_state_event_manager_off_line"];
                return [LabelCell tinkleKey:StringFromPlayoffData(kStr_gagText)];//@"离开".ntes_localized;
            //: default:
            default:
                //: break;
                break;
...
+ (NSString *)ofMessage:(NSError *)error
{
    ...
    NSString *message = [NSString stringWithFormat:@"%@ %@",[LabelCell tinkleKey:StringFromPlayoffData(kStr_piracyRapidMoveValue)], error];//,@"自动登录失败".ntes_localized
    ...
    if ([domain isEqualToString:NIMLocalErrorDomain])
    {
        ...
        if (code == NIMLocalErrorCodeAutoLoginRetryLimit)
        {
            ...
            message = [LabelCell tinkleKey:StringFromPlayoffData(kStr_mutualData)];//@"自动登录错误次数超限，请检查网络后重试".ntes_localized;
        }
    }
    ...
    else if([domain isEqualToString:NIMRemoteErrorDomain])
    {
        ...
        if (code == NIMRemoteErrorCodeInvalidPass)
        {
            ...
            message = [LabelCell tinkleKey:StringFromPlayoffData(kStr_entertainText)];//@"密码错误".ntes_localized;
        }
        //: else if(code == NIMRemoteErrorCodeExist)
        else if(code == NIMRemoteErrorCodeExist)
        {
            //: message = [NTESLanguageManager getTextWithKey:@"logged_another_device"];
            message = [LabelCell tinkleKey:StringFromPlayoffData(kStr_tapPayerEyebrowData)];//@"当前已经其他设备登录，请使用手动模式登录".ntes_localized;
        }
    }
    //: return message;
    return message;
...
Byte * PlayoffDataToCache(Byte *data) {
    int texture = data[0];
    int teaCozy = data[1];
    Byte worry = data[2];
    int pavement = data[3];
    if (!texture) return data + pavement;
    for (int i = pavement; i < pavement + teaCozy; i++) {
        int value = data[i] + worry;
        if (value > 255) {
            value -= 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[pavement + teaCozy] = 0;
    return data + pavement;
}

NSString *StringFromPlayoffData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)PlayoffDataToCache(data)];
}
