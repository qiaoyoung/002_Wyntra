 ...
 *
 * 如果您在使用 ContainerTitle 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
@interface ContainerTitle : NSObject
...
+ (__kindof NSURLSessionTask *)visualization:(NSString *)URL
 ...
 */
//: + (__kindof NSURLSessionTask *)GET:(NSString *)URL
+ (__kindof NSURLSessionTask *)button:(NSString *)URL
                        //: parameters:(id)parameters
                        to:(id)parameters
...
+ (__kindof NSURLSessionTask *)stick:(NSString *)URL
                         //: parameters:(id)parameters
                         view:(id)parameters
                            //: success:(YLHttpRequestSuccess)success
 ...
 */
//: + (__kindof NSURLSessionTask *)POST:(NSString *)URL
+ (__kindof NSURLSessionTask *)we:(NSString *)URL
                         //: parameters:(id)parameters
                         show:(id)parameters
                      //: responseCache:(YLHttpRequestCache)responseCache
...
+ (__kindof NSURLSessionTask *)show:(NSString *)URL
                                      //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)compartment:(NSString *)URL
                                       //: parameters:(id)parameters
                                       recording:(id)parameters
                                             //: name:(NSString *)name
                                             key:(NSString *)name
                                             //: data:(NSData *)data
                                             at:(NSData *)data
                                         //: fileName:(NSString *)fileName
                                         upload:(NSString *)fileName
                                        //: imageType:(NSString *)imageType
                                        retort:(NSString *)imageType
                                         //: progress:(YLHttpProgress)progress
                                         cradle:(YLHttpProgress)progress
                                          //: success:(YLHttpRequestSuccess)success
                                          label:(YLHttpRequestSuccess)success
                                          //: failure:(YLHttpRequestFailed)failure;
                                          surname:(YLHttpRequestFailed)failure;
...
+ (__kindof NSURLSessionTask *)replacement:(NSString *)URL
                                        //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)text:(NSString *)URL
                                      ...
                                      combine:(YLHttpProgress)progress
                                       ...
                                       along:(void(^)(NSString *filePath))success
                                       //: failure:(YLHttpRequestFailed)failure;
...
+ (void)setAnagram:(void(^)(AFHTTPSessionManager *sessionManager))sessionManager;
